...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int WOULD_YOU_LIKE_TO_WITHDRAW_FROM_THE_S1_CLAN_IF_YOU_LEAVE_YOU_WILL_HAVE_TO_WAIT_AT_LEAST_A_DAY_BEFORE_JOINING_ANOTHER_CLAN = 68; // Выйти из клана $s1? После
																																							// этого нельзя вступить в
																																							// другой клан в течение 24
																																							// ч.
	public static final int WOULD_YOU_LIKE_TO_DISMISS_S1_FROM_THE_CLAN_IF_YOU_DO_SO_YOU_WILL_HAVE_TO_WAIT_AT_LEAST_A_DAY_BEFORE_ACCEPTING_A_NEW_MEMBER = 69; // Исключить из клана
																																								// персонажа $s1? После
																																								// этого нельзя принимать
																																								// в клан других
																																								// персонажей в течение
																																								// 24 ч.
	...
	public static final int YOU_CANNOT_CREATE_ANOTHER_CHARACTER_PLEASE_DELETE_THE_EXISTING_CHARACTER_AND_TRY_AGAIN = 77; // Нельзя создать персонажа. Удалите уже существующего и
																															// повторите попытку.
	...
	public static final int YOU_HAVE_RECENTLY_BEEN_DISMISSED_FROM_A_CLAN_YOU_ARE_NOT_ALLOWED_TO_JOIN_ANOTHER_CLAN_FOR_24_HOURS = 199; // Вы исключены из клана и можете вступить в другой
																																		// только через 24 ч.
	...
	public static final int AFTER_A_CLAN_MEMBER_IS_DISMISSED_FROM_A_CLAN_THE_CLAN_MUST_WAIT_AT_LEAST_A_DAY_BEFORE_ACCEPTING_A_NEW_MEMBER = 231; // После исключения персонажа из клана
																																				// нужно подождать 24 ч, перед тем как
																																				// принять другого.
	public static final int AFTER_LEAVING_OR_HAVING_BEEN_DISMISSED_FROM_A_CLAN_YOU_MUST_WAIT_AT_LEAST_A_DAY_BEFORE_JOINING_ANOTHER_CLAN = 232; // Нельзя вступить в новый клан в течение
																																				// 24 ч после выхода из предыдущего.
	...
	public static final int YOU_HAVE_ALREADY_BEEN_AT_WAR_WITH_THE_S1_CLAN_5_DAYS_MUST_PASS_BEFORE_YOU_CAN_PROCLAIM_WAR_AGAIN = 247; // Вы уже воевали с кланом $s1. Перед повторным
																																	// объявлением войны должно пройти 5 дней.
	...
	public static final int FAME_LEVEL_HAS_DECREASED_5_DAYS_HAVE_NOT_PASSED_SINCE_YOU_WERE_REFUSED_WAR = 260; // После окончания войны кланов не прошло 5 дней, репутация клана
																												// понизилась.
	...
	public static final int THERE_IS_A_SIGNIFICANT_DIFFERENCE_BETWEEN_THE_ITEMS_PRICE_AND_ITS_STANDARD_PRICE_PLEASE_CHECK_AGAIN = 418; // Цена предмета слишком высока по сравнению со
																																		// стандартной. Пожалуйста, измените цену.
	...
	public static final int YOUR_ACCOUNT_HAS_BEEN_REPORTED_FOR_INTENTIONALLY_NOT_PAYING_THE_CYBER_CAFE_FEES = 426; // От администрации компьютерного клуба поступила жалоба, что Ваша
																													// учетная запись была замечена на компьютере с неоплаченным
																													// временем.
	public static final int PLEASE_CONTACT_US = 427; // Пожалуйста, свяжитесь со службой поддержки.
	public static final int IN_ACCORDANCE_WITH_COMPANY_POLICY_YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_DUE_TO_SUSPICION_OF_ILLEGAL = 428; // В соответствии с политикой компании, Ваш аккаунт был
																																	// заблокирован за подозрение в нелегальной
																																	// деятельности/присвоении чужих данных. Если Вы не
																																	// считаете себя виновным, посетите наш сайт и
																																	// обратитесь в службу поддержки для подачи
																																	// апелляции.
	public static final int IN_ACCORDANCE_WITH_COMPANY_POLICY_YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_DUE_TO_FALSELY_REPORTING_A = 429; // В соответствии с политикой компании, Ваш аккаунт был
																																// заблокирован за ложный доклад о присвоении аккаунта.
																																// Такие доклады могут навредить честным игрокам. За
																																// дополнительной информацией обратитесь в службу
																																// поддержки на сайте.
	public static final int __DOESNT_NEED_TO_TRANSLATE = 430; // (перевод не нужен)
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_DUE_TO_VIOLATING_THE_EULA_ROC_AND_OR_USER_AGREEMENT_CHAPTER_4 = 431; // Ваш аккаунт был заблокирован за нарушение
																																	// Пользовательского Соглашения. В случае
																																	// несоблюдения условий соглашения со стороны
																																	// пользователя компания имеет право заблокировать
																																	// его учетную запись. За дополнительной информацией
																																	// обратитесь в службу поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_7_DAYS_RETROACTIVE_TO_THE_DAY_OF_DISCLOSURE_UNDER_CHAPTER_3 = 432; // Ваш аккаунт был заблокирован на 7 дней (со дня
																																	// оглашения) в соответствии с Пользовательским
																																	// Соглашением за проведение денежных операций (или
																																	// их попытку) с игровыми предметами, персонажами
																																	// (аккаунтами) или игровой валютой. Через 7 дней Ваш
																																	// аккаунт автоматически разблокируется. За
																																	// дополнительной информацией обратитесь в службу
																																	// поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE = 433; // Ваш аккаунт был заблокирован в соответствии с
																															// Пользовательским Соглашением за обмен (или попытку обмена)
																															// игровых предметов/персонажей на наличные деньги или
																															// предметы из другой игры. За дополнительной информацией
																															// обратитесь в службу поддержки на сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE_1 = 434; // Ваш аккаунт был заблокирован в соответствии с
																																// Пользовательским Соглашением за непристойное поведение
																																// или мошенничество. За дополнительной информацией
																																// обратитесь в службу поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE_2 = 435; // Ваш аккаунт был заблокирован в соответствии с
																																// Пользовательским Соглашением за непристойное
																																// поведение. За дополнительной информацией обратитесь в
																																// службу поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE_3 = 436; // Ваш аккаунт был заблокирован в соответствии
																																// Пользовательским Соглашением за злоупотребление
																																// игровой системой и использование ошибок игры с целью
																																// получения выгоды. Использование ошибок нарушает
																																// игровой баланс. За дополнительной информацией
																																// обратитесь в службу поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE_4 = 437; // Ваш аккаунт был заблокирован в соответствии с
																																// Пользовательским Соглашением за использование
																																// нелегального программного обеспечения. За
																																// дополнительной информацией обратитесь в службу
																																// поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_3_SECTION_14_OF_THE_LINEAGE_II_SERVICE_USE_5 = 438; // Ваш аккаунт был заблокирован в соответствии с
																																// Пользовательским Соглашением за попытку выдать себя за
																																// представителя службы поддержки или штатного сотрудника
																																// компании. За дополнительной информацией обратитесь в
																																// службу поддержки на нашем сайте.
	public static final int IN_ACCORDANCE_WITH_THE_COMPANYS_USER_AGREEMENT_AND_OPERATIONAL_POLICY_THIS_ACCOUNT_HAS_BEEN = 439; // В соответствии с Пользовательским Соглашением и
																																// политикой компании этот аккаунт заблокирован по
																																// просьбе владельца. Если у Вас есть вопросы по поводу
																																// аккаунта, обратитесь в службу поддержки на нашем
																																// сайте.
	public static final int BECAUSE_YOU_ARE_REGISTERED_AS_A_MINOR_YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_AT_THE_REQUEST_OF_YOUR = 440; // Вы зарегистрированы как несовершеннолетний, и Ваш
																																// аккаунт был заблокирован по просьбе ваших родителей
																																// или опекунов. За дополнительной информацией обратитесь
																																// в службу поддержки на нашем сайте.
	public static final int PER_OUR_COMPANYS_USER_AGREEMENT_THE_USE_OF_THIS_ACCOUNT_HAS_BEEN_SUSPENDED_IF_YOU_HAVE_ANY = 441; // В соответствии с Пользовательским Соглашением данный
																																// аккаунт был заблокирован. Если у Вас есть вопросы
																																// касательно этого аккаунта, обратитесь в службу
																																// поддержки на нашем сайте.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_UNDER_CHAPTER_2_SECTION_7_OF_THE_LINEAGE_II_SERVICE_USE = 442; // Ваш аккаунт был заблокирован в соответствии с
																															// Пользовательским Соглашением за присвоение платы другого
																															// аккаунта. За дополнительной информацией обратитесь в
																															// службу поддержки на нашем сайте.
	public static final int THE_IDENTITY_OF_THIS_ACCOUNT_HAS_NOT_BEEN_VEEN_VERIFIED_THEREFORE_LINEAGE_II_SERVICE_FOR_THIS = 443; // Подлинность Вашего аккаунта не была подтверждена,
																																	// потому его действие сейчас приостановлено. Для
																																	// подтверждения подлинности, пожалуйста, вышлите нам
																																	// данные аккаунта, Ваши личные данные, копию
																																	// документа, удостоверяющего Вашу личность, и
																																	// контактную информацию. За дополнительными
																																	// сведениями обратитесь в службу поддержки на нашем
																																	// сайте.
	public static final int SINCE_WE_HAVE_RECEIVED_A_WITHDRAWAL_REQUEST_FROM_THE_HOLDER_OF_THIS_ACCOUNT_ACCESS_TO_ALL = 444; // Получен запрос на блокировку аккаунта от его владельца,
	...
	public static final int FOR_MORE_INFORMATION_PLEASE_VISIT_THE_SUPPORT_CENTER_ON_THE_PLAYNC_WEBSITE_HTTP___WWWPLAYNCCOM = 446; // Дополнительную информацию можно получить в службе
																																	// поддержки на нашем сайте.
	...
	public static final int FOR_MORE_DETAILS_PLEASE_CONTACT_OUR_CUSTOMER_SERVICE_CENTER_AT_HTTP__SUPPORTPLAYNCCOM = 454; // Для получения дополнительной информации обратитесь в службу
																															// поддержки на нашем сайте.
	public static final int THE_ACCOUNT_IS_ALREADY_IN_USE_ACCESS_DENIED = 455; // Такой аккаунт уже используется. Войти невозможно.
	public static final int LINEAGE_II_GAME_SERVICES_MAY_BE_USED_BY_INDIVIDUALS_15_YEARS_OF_AGE_OR_OLDER_EXCEPT_FOR_PVP_SERVERS = 456; // В Lineage II могут играть пользователи, которым
																																		// не менее 15 лет, на PvP серверах – не менее 18
																																		// лет.
	...
	public static final int YOU_MAY_NOT_ACCEPT_ANY_CLAN_WITHIN_A_DAY_AFTER_EXPELLING_ANOTHER_CLAN = 467; // После исключения клана из альянса Вы можете принять новый клан только через
																											// 24 часа.
	public static final int A_CLAN_THAT_HAS_WITHDRAWN_OR_BEEN_EXPELLED_CANNOT_ENTER_INTO_AN_ALLIANCE_WITHIN_ONE_DAY_OF_WITHDRAWAL_OR_EXPULSION = 468; // Исключенный из альянса или
																																						// покинувший его клан не может
																																						// вступить в новый в течение 24
																																						// ч.
	...
	public static final int DUE_TO_THE_VOLUME_LIMIT_OF_THE_PETS_INVENTORY_NO_MORE_ITEMS_CAN_BE_PLACED_THERE = 545; // Инвентарь питомца переполнен. Удалите что-нибудь и повторите
																													// попытку.
	...
	public static final int DURING_THE_GRACE_PERIOD_FOR_DISSOLVING_A_CLAN_REGISTRATION_OR_DELETION_OF_A_CLANS_CREST_IS_NOT_ALLOWED = 552; // Нельзя изменить/удалить эмблему клана во
																																			// время роспуска клана.
	...
	public static final int CAUTION_THE_ITEM_PRICE_GREATLY_DIFFERS_FROM_THE_SHOPS_STANDARD_PRICE_DO_YOU_WISH_TO_CONTINUE = 569; // Внимание - цена предмета сильно отличается от цены в
																																// магазине. Продолжить?
	...
	public static final int DO_YOU_WISH_TO_DISMISS_YOUR_PET_DISMISSING_YOUR_PET_WILL_CAUSE_THE_PET_NECKLACE_TO_DISAPPEAR = 592; // Уничтожить питомца? При уничтожении пропадет ошейник
																																// питомца.
	...
	public static final int YOU_DO_NOT_HAVE_ANY_FURTHER_SKILLS_TO_LEARN__COME_BACK_WHEN_YOU_HAVE_REACHED_LEVEL_S1 = 607; // Вы не можете изучать умения. Возвращайтесь, когда достигнете
																															// $s1-го уровня.
	...
	public static final int THIS_SERVER_IS_RESERVED_FOR_PLAYERS_IN_KOREA__TO_USE_LINEAGE_II_GAME_SERVICES_PLEASE_CONNECT_TO_THE_SERVER_IN_YOUR_REGION = 621; // Вы заходите в игру с
																																								// запрещенного IP.
	...
	public static final int YOU_HAVE_ALREADY_BEEN_AT_WAR_WITH_THE_S1_CLAN_5_DAYS_MUST_PASS_BEFORE_YOU_CAN_DECLARE_WAR_AGAIN = 628; // Вы уже воевали с кланом $s1. Повторно объявить
																																	// войну можно через 5 дней после окончания
																																	// предыдущей.
	public static final int YOUR_OPPONENT_HAS_EXCEEDED_THE_NUMBER_OF_SIMULTANEOUS_ALLIANCE_BATTLES_ALLOWED_1 = 629; // Противник уже находится в состоянии войны с максимальным
																													// количеством кланов.
	...
	public static final int YOUR_APPLICATION_HAS_BEEN_DENIED_BECAUSE_YOU_HAVE_ALREADY_SUBMITTED_A_REQUEST_FOR_ANOTHER_SIEGE_BATTLE = 639; // Вы уже подали заявку на участие в другой
																																			// осаде крепости. Нельзя подать повторную
																																			// заявку.
	...
	public static final int YOU_ARE_ALREADY_REGISTERED_TO_THE_ATTACKER_SIDE_AND_MUST_CANCEL_YOUR_REGISTRATION_BEFORE_SUBMITTING_YOUR_REQUEST = 642; // Вы подали заявку на участие в
																																					// атаке крепости. Необходимо
																																					// отменить ее и повторить попытку.
	public static final int YOU_HAVE_ALREADY_REGISTERED_TO_THE_DEFENDER_SIDE_AND_MUST_CANCEL_YOUR_REGISTRATION_BEFORE_SUBMITTING_YOUR_REQUEST = 643; // Вы подали заявку на участие в
																																						// обороне крепости. Необходимо
																																						// отменить ее и повторить
																																						// попытку.
	...
	public static final int ONLY_CLANS_WITH_LEVEL_4_AND_HIGHER_MAY_REGISTER_FOR_A_CASTLE_SIEGE = 645; // Подать заявку на участие в осаде крепости могут только кланы, достигшие 5-го
																										// уровня.
	...
	public static final int THIS_IS_NOT_A_MERCENARY_OF_A_CASTLE_THAT_YOU_OWN_AND_SO_YOU_CANNOT_CANCEL_ITS_POSITIONING = 658; // Этот наемник не принадлежит Вашему замку, поэтому нельзя
																																// изменить его местоположение.
	public static final int THIS_IS_NOT_THE_TIME_FOR_SIEGE_REGISTRATION_AND_SO_REGISTRATIONS_CANNOT_BE_ACCEPTED_OR_REJECTED = 659; // Сейчас не время для регистрации на участие в осаде
																																	// крепости, поэтому одобрить или отменить заявку
																																	// невозможно.
	public static final int THIS_IS_NOT_THE_TIME_FOR_SIEGE_REGISTRATION_AND_SO_REGISTRATION_AND_CANCELLATION_CANNOT_BE_DONE = 660; // Сейчас не время для регистрации на участие в осаде
																																	// крепости, поэтому подать или отменить заявку
																																	// невозможно.
	...
	public static final int YOU_ARE_REGISTERING_ON_THE_ATTACKING_SIDE_OF_THE_S1_SIEGE_DO_YOU_WANT_TO_CONTINUE = 667; // Вас добавляют в список атакующих в осаде крепости $s1.
																														// Продолжить?
	public static final int YOU_ARE_REGISTERING_ON_THE_DEFENDING_SIDE_OF_THE_S1_SIEGE_DO_YOU_WANT_TO_CONTINUE = 668; // Вас добавляют в список защитников в осаде крепости $s1.
																														// Продолжить?
	public static final int YOU_ARE_CANCELING_YOUR_APPLICATION_TO_PARTICIPATE_IN_THE_S1_SIEGE_BATTLE_DO_YOU_WANT_TO_CONTINUE = 669; // Заявка на участие в осаде $s1 будет отменена.
																																	// Продолжить?
	public static final int YOU_ARE_REFUSING_THE_REGISTRATION_OF_S1_CLAN_ON_THE_DEFENDING_SIDE_DO_YOU_WANT_TO_CONTINUE = 670; // Заявка на участие в защите крепости клана $s1 будет
																																// отклонена. Продолжить?
	public static final int YOU_ARE_AGREEING_TO_THE_REGISTRATION_OF_S1_CLAN_ON_THE_DEFENDING_SIDE_DO_YOU_WANT_TO_CONTINUE = 671; // Заявка на участие в защите крепости клана $s1 будет
																																	// одобрена. Продолжить?
	...
	public static final int THE_CLAN_THAT_OWNS_THE_CASTLE_IS_AUTOMATICALLY_REGISTERED_ON_THE_DEFENDING_SIDE = 688; // Клан, владеющий замком, автоматически заносится в список
																													// защитников.
	...
	public static final int YOU_CANNOT_REGISTER_ON_THE_ATTACKING_SIDE_BECAUSE_YOU_ARE_PART_OF_AN_ALLIANCE_WITH_THE_CLAN_THAT_OWNS_THE_CASTLE = 690; // Так как Вы состоите в одном
																																					// альянсе с кланом, владеющим
																																					// крепостью, Вы не можете войти в
																																					// состав осаждающих замок.
	...
	public static final int THE_PURCHASE_PRICE_IS_HIGHER_THAN_THE_AMOUNT_OF_MONEY_THAT_YOU_HAVE_AND_SO_YOU_CANNOT_OPEN_A_PERSONAL_STORE = 720; // Цена покупки превышает Ваш капитал,
																																				// поэтому начать торговлю невозможно.
	...
	public static final int YOU_CANNOT_DISSOLVE_AN_ALLIANCE_WHILE_AN_AFFILIATED_CLAN_IS_PARTICIPATING_IN_A_SIEGE_BATTLE = 722; // Один из кланов, входящих в альянс, участвует в осаде
																																// замка, поэтому распустить альянс невозможно.
	...
	public static final int WE_HAVE_RECEIVED_S1_PETITIONS_FROM_YOU_TODAY_AND_THAT_IS_THE_MAXIMUM_THAT_YOU_CAN_SUBMIT_IN_ONE_DAY_YOU_CANNOT_SUBMIT_ANY_MORE_PETITIONS = 733; // Сегодня Вы
																																											// отправили
																																											// максимальное
																																											// количество
																																											// петиций.
																																											...
																																											// отправить
																																											// нельзя.
	public static final int YOU_FAILED_AT_SUBMITTING_A_PETITION_ON_BEHALF_OF_SOMEONE_ELSE_S1_ALREADY_SUBMITTED_A_PETITION = 734; // Не удалось подать петицию за кого-то другого. $c1 уже
																																	// отправил петицию.
	...
	public static final int AS_THERE_IS_A_CONFLICT_IN_THE_SIEGE_RELATIONSHIP_WITH_A_CLAN_IN_THE_ALLIANCE_YOU_CANNOT_INVITE_THAT_CLAN_TO_THE_ALLIANCE = 751; // Клан участвует в осаде
																																							// замка на вражеской
																																							// стороне. Нельзя пригласить
																																							// в состав альянса.
	...
	public static final int S1_CANNOT_JOIN_THE_CLAN_BECAUSE_ONE_DAY_HAS_NOT_YET_PASSED_SINCE_HE_SHE_LEFT_ANOTHER_CLAN = 760; // $c1 не может вступить в клан. Не прошло 24 ч с момента
																																// выхода из предыдущего.
	public static final int S1_CLAN_CANNOT_JOIN_THE_ALLIANCE_BECAUSE_ONE_DAY_HAS_NOT_YET_PASSED_SINCE_IT_LEFT_ANOTHER_ALLIANCE = 761; // Клан $s1 вышел из альянса менее 24 ч назад и не
																																		// может войти в состав альянса вновь.
	...
	public static final int THERE_IS_A_GAMEGUARD_INITIALIZATION_ERROR_PLEASE_TRY_RUNNING_IT_AGAIN_AFTER_REBOOTING = 766; // Ошибка обновления программы GameGuard. Перезагрузите
	...
	public static final int A_HACKING_TOOL_HAS_BEEN_DISCOVERED_PLEASE_TRY_PLAYING_AGAIN_AFTER_CLOSING_UNNECESSARY_PROGRAMS = 769; // Обнаружен взлом. Выключите ненужные программы и
																																	// повторите попытку.
	public static final int THE_GAMEGUARD_UPDATE_WAS_CANCELED_PLEASE_CHECK_YOUR_NETWORK_CONNECTION_STATUS_OR_FIREWALL = 770; // Обновление программы GameGuard отменено. Проверьте
	...
	public static final int PETITIONS_ARE_NOT_BEING_ACCEPTED_AT_THIS_TIME_YOU_MAY_SUBMIT_YOUR_PETITION_AFTER_S1_AM_PM = 802; // Невозможно открыть еще одно окно зрителя. Закройте уже
																																// открытое окно и повторите попытку.
	...
	public static final int PETITIONS_ARE_NOT_BEING_ACCEPTED_AT_THIS_TIME_YOU_MAY_SUBMIT_YOUR_PETITION_AFTER_S1_AM_PM_1 = 805; // На данный момент петиция еще не была принята.
																																// Попробуйте повторить попытку через $s1 ч.
	...
	public static final int THIS_TERRAIN_IS_UNNAVIGABLE_PREPARE_FOR_TRANSPORT_TO_THE_NEAREST_VILLAGE = 807; // Вы находитесь в зоне, где перемещение невозможно, мы переместим Вас в
																											// ближайший город.
	...
	public static final int TICKETS_SALES_ARE_CLOSED_FOR_THE_S1TH_MONSTER_RACE_ODDS_ARE_POSTED = 819; // Продажа билетов на участие в гонке монстров $s1 завершена. Вы можете просмотреть
																										// сумму выигрыша.
	...
	public static final int YOU_MAY_NOT_BUILD_YOUR_HEADQUARTERS_IN_CLOSE_PROXIMITY_TO_ANOTHER_HEADQUARTERS = 860; // Вы не можете установить штаб в этом месте, дистанция до другого
																													// штаба слишком мала.
	...
	public static final int ITEMS_CANNOT_BE_DISCARDED_OR_DESTROYED_WHILE_OPERATING_A_PRIVATE_STORE_OR_WORKSHOP = 958; // Предмет нельзя выбросить или уничтожить в режиме личной торговой
																														// лавки или мастерской.
	...
	public static final int CHATTING_IS_CURRENTLY_PROHIBITED_IF_YOU_TRY_TO_CHAT_BEFORE_THE_PROHIBITION_IS_REMOVED_THE_PROHIBITION_TIME_WILL_BECOME_EVEN_LONGER = 966; // Блокировка чата.
																																										// В случае
																																										// попытки
																																										// использования
																																										// чата время
																																										...
																																										// будет
																																										// продлено.
	public static final int DO_YOU_ACCEPT_THE_PARTY_INVITATION_FROM_S1_ITEM_DISTRIBUTION_RANDOM_INCLUDING_SPOIL = 967; // Вы согласны вступить в группу с $c1? (распределение предметов:
																														// Случайно+Присвоить)
	...
	public static final int DO_YOU_ACCEPT_THE_PARTY_INVITATION_FROM_S1_ITEM_DISTRIBUTION_BY_TURN_INCLUDING_SPOIL = 969; // Вы согласны вступить в группу с $c1? (распределение предметов:
	...
	public static final int THE_SOUL_CRYSTALS_CAUSED_RESONATION_AND_FAILED_AT_ABSORBING_A_SOUL = 977; // Кристалл души не смог поглотить душу, из-за того что кристаллы души вызвали
																										// резонанс.
	...
	public static final int ITEMS_LEFT_AT_THE_CLAN_HALL_WAREHOUSE_CAN_ONLY_BE_RETRIEVED_BY_THE_CLAN_LEADER_DO_YOU_WANT_TO_CONTINUE = 1039; // Предметы, находящиеся в хранилище клана,
																																			// может забрать только глава клана.
																																			// Продолжить?
	...
	public static final int AT_THE_CURRENT_TIME_THE__UNSTUCK_COMMAND_CANNOT_BE_USED_PLEASE_SEND_IN_A_PETITION = 1043; // Сейчас нельзя использовать команду "/unstuck". Обратитесь в
																														// службу поддержки.
	...
	public static final int IT_IS_NOT_POSSIBLE_TO_MAKE_INVITATIONS_FOR_ORGANIZING_PARTIES_IN_STATE_OF_OVERALL_BLOCKING = 1049; // Пригласить в группу в режиме полной блокировки
																																// невозможно.
	public static final int THERE_ARE_NO_COMMUNITIES_IN_MY_CLAN_CLAN_COMMUNITIES_ARE_ALLOWED_FOR_CLANS_WITH_SKILL_LEVELS_OF_2_AND_HIGHER = 1050; // В клане нет функции сообщества.
																																					// Клановые сообщества доступны
																																					// только для кланов 2-го уровня и
																																					// выше.
	public static final int PAYMENT_FOR_YOUR_CLAN_HALL_HAS_NOT_BEEN_MADE_PLEASE_MAKE_PAYMENT_TO_YOUR_CLAN_WAREHOUSE_BY_S1_TOMORROW = 1051; // Вы не сдали деньги за использование холла
																																			// клана. Просим Вас положить необходимую
																																			// сумму в хранилище клана до $s1 завтрашнего
																																			// дня.
	public static final int THE_CLAN_HALL_FEE_IS_ONE_WEEK_OVERDUE_THEREFORE_THE_CLAN_HALL_OWNERSHIP_HAS_BEEN_REVOKED = 1052; // Вы опоздали с арендой холла клана на неделю, вследствие
																																// чего право на владение холлом отменено.
	public static final int IT_IS_IMPOSSIBLE_TO_BE_RESSURECTED_IN_BATTLEFIELDS_WHERE_SIEGE_WARS_ARE_IN_PROCESS = 1053; // Во время проведения осад Вы не можете пользоваться функцией
																														// воскрешения.
	...
	public static final int THE_RECIPE_CANNOT_BE_REGISTERED__YOU_DO_NOT_HAVE_THE_ABILITY_TO_CREATE_ITEMS = 1061; // У Вас нет умения изготавливать предметы, зарегистрировать рецепт не
																													// получится.
	...
	public static final int WHILE_OPERATING_A_PRIVATE_STORE_OR_WORKSHOP_YOU_CANNOT_DISCARD_DESTROY_OR_TRADE_AN_ITEM = 1065; // В личной торговой лавке или мастерской обмен или удаление
																															// предмета невозможно.
	...
	public static final int YOU_DO_NOT_MEET_THE_AGE_REQUIREMENT_TO_PURCHASE_A_MONSTER_RACE_TICKET = 1074; // Вы не можете приобрести билет на гонки монстров из-за ограничения по
																											// возрасту.
	public static final int THE_GAME_CANNOT_BE_TERMINATED = 1076; // Невозможно выйти из игры.
	public static final int A_GAMEGUARD_EXECUTION_ERROR_HAS_OCCURRED_PLEASE_SEND_THE_ERL_FILE_S_LOCATED_IN_THE_GAMEGUARD_FOLDER_TO_GAME = 1077; // Ошибка при активации GameGuard.
																																				// Обратитесь в службу поддержки на нашем
																																				// сайте.
	...
	public static final int DO_YOU_WISH_TO_USE_THE_FACELIFTING_POTION_X_TYPE_A_IT_IS_PERMANENT = 1080; // Вы хотите воспользоваться зельем изменения внешности - тип А? Эффект от этого
																										// зелья останется навсегда.
	public static final int DO_YOU_WISH_TO_USE_THE_DYE_POTION_X_TYPE_A_IT_IS_PERMANENT = 1081; // Вы хотите воспользоваться зельем изменения цвета волос - тип А? Эффект от этого зелья
																								// останется навсегда.
	public static final int DO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_A_IT_IS_PERMANENT = 1082; // Вы хотите воспользоваться зельем изменения прически - тип А? Эффект от
																												// этого зелья останется навсегда.
	...
	public static final int DO_YOU_WISH_TO_USE_THE_FACELIFTING_POTION_X_TYPE_B_IT_IS_PERMANENT = 1090; // Вы хотите воспользоваться зельем изменения внешности - тип В? Эффект от этого
																										// зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_FACELIFTING_POTION_X_TYPE_C_IT_IS_PERMANENT = 1091; // Вы хотите воспользоваться зельем изменения внешности - тип С? Эффект от этого
																										// зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_DYE_POTION_X_TYPE_B_IT_IS_PERMANENT = 1092; // Вы хотите воспользоваться зельем изменения цвета волос - тип В? Эффект от этого зелья
																								// останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_DYE_POTION_X_TYPE_C_IT_IS_PERMANENT = 1093; // Вы хотите воспользоваться зельем изменения цвета волос - тип С? Эффект от этого зелья
																								// останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_DYE_POTION_X_TYPE_D_IT_IS_PERMANENT = 1094; // Вы хотите воспользоваться зельем изменения цвета волос - тип D? Эффект от этого зелья
																								// останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_B_IT_IS_PERMANENT = 1095; // Вы хотите воспользоваться зельем изменения прически - тип B? Эффект от
																												// этого зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_C_IT_IS_PERMANENT = 1096; // Вы хотите воспользоваться зельем изменения прически - тип C? Эффект от
																												// этого зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_D_IT_IS_PERMANENT = 1097; // Вы хотите воспользоваться зельем изменения прически - тип D? Эффект от
																												// этого зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_E_IT_IS_PERMANENT = 1098; // Вы хотите воспользоваться зельем изменения прически - тип E? Эффект от
																												// этого зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_F_IT_IS_PERMANENT = 1099; // Вы хотите воспользоваться зельем изменения прически - тип F? Эффект от
																												// этого зелья останется навсегда.
	public static final int XDO_YOU_WISH_TO_USE_THE_HAIR_STYLE_CHANGE_POTION_X_TYPE_G_IT_IS_PERMANENT = 1100; // Вы хотите воспользоваться зельем изменения прически - тип G? Эффект от
																												// этого зелья останется навсегда.
	...
	public static final int THE_PRIZE_AMOUNT_FOR_THE_WINNER_OF_LOTTERY__S1__IS_S2_ADENA_WE_HAVE_S3_FIRST_PRIZE_WINNERS = 1112; // Джекпот лотереи $s1 составил $s2 аден. Количество
																																// победителей: $s3 чел.
	public static final int THE_PRIZE_AMOUNT_FOR_LUCKY_LOTTERY__S1__IS_S2_ADENA_THERE_WAS_NO_FIRST_PRIZE_WINNER_IN_THIS_DRAWING_THEREFORE_THE_JACKPOT_WILL_BE_ADDED_TO_THE_NEXT_DRAWING = 1113; // Джекпот
																																																...
																																																// следующей
																																																// лотерее.
	public static final int YOUR_CLAN_MAY_NOT_REGISTER_TO_PARTICIPATE_IN_A_SIEGE_WHILE_UNDER_A_GRACE_PERIOD_OF_THE_CLANS_DISSOLUTION = 1114; // Во время роспуска клана
																																				// зарегистрироваться в осаде замка
																																				// нельзя.
	...
	public static final int PROGRESS_IN_A_QUEST_IS_POSSIBLE_ONLY_WHEN_YOUR_INVENTORYS_WEIGHT_AND_VOLUME_ARE_LESS_THAN_80_PERCENT_OF_CAPACITY = 1118; // Чтобы продолжить квест,
																																						// разгрузите инвентарь (менее
																																						// 80%).
	...
	public static final int WHILE_YOU_ARE_ENGAGED_IN_COMBAT_YOU_CANNOT_OPERATE_A_PRIVATE_STORE_OR_PRIVATE_WORKSHOP = 1135; // Во время битвы функциями торговли или изготовления
	...
	public static final int SINCE_YOU_DO_NOT_HAVE_ENOUGH_ITEMS_TO_MAINTAIN_THE_SERVITORS_STAY_THE_SERVITOR_WILL_DISAPPEAR = 1143; // Слуга исчезнет, так как у Вас не хватает предметов
																																	// для его содержания.
	...
	public static final int TRYING_ON_STATE_LASTS_FOR_ONLY_5_SECONDS_WHEN_A_CHARACTERS_STATE_CHANGES_IT_CAN_BE_CANCELLED = 1157; // Примерка снаряжения длится 10 секунд. В случае
																																	// изменения Вашего состояния режим примерки может
																																	// быть отменен.
	public static final int YOU_CANNOT_GET_DOWN_FROM_A_PLACE_THAT_IS_TOO_HIGH = 1158; // Вы не можете спешиться с такой высоты.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_10_MINUTES = 1159; // Корабль с Говорящего Острова прибудет в гавань Глудина
																															// через 10 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_5_MINUTES = 1160; // Корабль с Говорящего Острова прибудет в гавань Глудина
																																// через 5 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_1_MINUTE = 1161; // Корабль с Говорящего Острова прибудет в гавань Глудина
																																// через 1 мин.
	public static final int THE_FERRY_FROM_GIRAN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_15_MINUTES = 1162; // Корабль из гавани Гирана прибудет на Говорящий Остров
																																// через 15 мин.
	public static final int THE_FERRY_FROM_GIRAN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_10_MINUTES = 1163; // Корабль из гавани Гирана прибудет на Говорящий Остров
																																// через 10 мин.
	public static final int THE_FERRY_FROM_GIRAN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_5_MINUTES = 1164; // Корабль из гавани Гирана прибудет на Говорящий Остров
																																// через 5 мин.
	public static final int THE_FERRY_FROM_GIRAN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_1_MINUTE = 1165; // Корабль из гавани Гирана прибудет на Говорящий Остров
																																// через 1 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GIRAN_HARBOR_IN_APPROXIMATELY_20_MINUTES = 1166; // Корабль с Говорящего Острова прибудет в гавань Гирана
																																// через 20 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GIRAN_HARBOR_IN_APPROXIMATELY_15_MINUTES = 1167; // Корабль с Говорящего Острова прибудет в гавань Гирана
																																// через 15 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GIRAN_HARBOR_IN_APPROXIMATELY_10_MINUTES = 1168; // Корабль с Говорящего Острова прибудет в гавань Гирана
																																// через 10 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GIRAN_HARBOR_IN_APPROXIMATELY_5_MINUTES = 1169; // Корабль с Говорящего Острова прибудет в гавань Гирана
																																// через 5 мин.
	public static final int THE_FERRY_FROM_TALKING_ISLAND_WILL_BE_ARRIVING_AT_GIRAN_HARBOR_IN_APPROXIMATELY_1_MINUTE = 1170; // Корабль с Говорящего Острова прибудет в гавань Гирана
																																// через 1 мин.
	...
	public static final int IF_YOU_HAVE_LOST_YOUR_ACCOUNT_INFORMATION_PLEASE_VISIT_THE_OFFICIAL_LINEAGE_II_SUPPORT_WEBSITE_AT_HTTP__SUPPORTPLAYNCCOM = 1187; // Если Вы забыли свой логин
																																								// или пароль, обратитесь
																																								// в службу поддержки на
																																								// сайте.
	public static final int THE_TEMPORARY_ALLIANCE_OF_THE_CASTLE_ATTACKER_TEAM_IS_IN_EFFECT_IT_WILL_BE_DISSOLVED_WHEN_THE_CASTLE_LORD_IS_REPLACED = 1189; // Создан временный альянс на
																																							// период осады замка. При
																																							// смене хозяина замка альянс
																																							// будет распущен.
	...
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_10_MINUTES = 1191; // Корабль из гавани Глудина до Говорящего Острова
																																// отправляется через 10 мин.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_5_MINUTES = 1192; // Корабль из гавани Глудина до Говорящего Острова
																																// отправляется через 5 мин.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_1_MINUTE = 1193; // Корабль из гавани Глудина до Говорящего Острова
																																// отправляется через 1 мин.
	public static final int A_MERCENARY_CAN_BE_ASSIGNED_TO_A_POSITION_FROM_THE_BEGINNING_OF_THE_SEAL_VALIDATION_PERIOD_UNTIL_THE_TIME_WHEN_A_SIEGE_STARTS = 1194; // Наемников можно
																																									// расставлять с
																																									// начала периода
																																									// действия Печати до
																																									// начала осады
	...
	public static final int SEVEN_SIGNS_THE_QUEST_EVENT_PERIOD_HAS_BEGUN_VISIT_A_PRIEST_OF_DAWN_OR_DUSK_TO_PARTICIPATE_IN_THE_EVENT = 1210; // Семь Печатей: Квестовый ивент начался. Вы
																																			// можете участвовать в нем, пообщавшись со
																																			// Жрецом Рассвета или Жрицей Заката.
	public static final int SEVEN_SIGNS_THE_QUEST_EVENT_PERIOD_HAS_ENDED_THE_NEXT_QUEST_EVENT_WILL_START_IN_ONE_WEEK = 1211; // Семь Печатей: Квестовый ивент завершен. Следующий пройдет
																																// через неделю.
	...
	public static final int NO_MORE_MESSAGES_MAY_BE_SENT_AT_THIS_TIME_EACH_ACCOUNT_IS_ALLOWED_10_MESSAGES_PER_DAY = 1229; // Вы не можете послать письмо. В день можно послать не более
																															// 10 писем.
	...
	public static final int YOUR_TEMPORARY_MAILBOX_IS_FULL_NO_MORE_MAIL_CAN_BE_STORED_10_MESSAGE_LIMIT = 1238; // Ваш черновик полон. Вы можете хранить в черновиках не более 10
																												// сообщений.
	public static final int LOADING_OF_THE_KEYBOARD_SECURITY_MODULE_HAS_FAILED_PLEASE_EXIT_THE_GAME_AND_RELOAD = 1239; // Ошибка при загрузке модуля безопасности ввода через клавиатуру.
																														// Для повторной попытки перезайдите в игру.
	...
	public static final int USERS_WHO_HAVE_NOT_VERIFIED_THEIR_AGE_CANNOT_LOG_IN_BETWEEN_1000_PM_AND_600_AM = 1242; // Пользователи, не подтвердившие достижение 18 лет, не могут войти в
																													// игру с 22:00 до 6:00.
	public static final int THE_SECURITY_CARD_NUMBER_IS_INVALID = 1243; // Номер карты недействителен.
	public static final int USERS_WHO_HAVE_NOT_VERIFIED_THEIR_AGE_CANNOT_LOG_IN_BETWEEN_1000_PM_AND_600_AM_LOGGING_OFF = 1244; // Подключение для пользователей, не подтвердивших
																																// достижение 18 лет, невозможно с 22:00 до 6:00. Игра
																																// будет отключена.
	...
	public static final int DO_YOU_REALLY_WANT_TO_SURRENDER_IF_YOU_SURRENDER_DURING_AN_ALLIANCE_WAR_YOUR_EXP_WILL_DROP_AS_MUCH_AS_WHEN_YOUR_CHARACTER_DIES_ONCE = 1250; // Вы хотите
																																										// сдаться? При
																																										// капитуляции
																																										// альянса будет
																																										// снято
	...
	public static final int ARE_YOU_SURE_YOU_WANT_TO_DISMISS_THE_ALLIANCE_IF_YOU_USE_THE__ALLYDISMISS_COMMAND_YOU_WILL_NOT_BE_ABLE_TO_ACCEPT_ANOTHER_CLAN_TO_YOUR_ALLIANCE_FOR_ONE_DAY = 1251; // Вы
																																																...
																																																// другим
																																																// кланом.
	public static final int ARE_YOU_SURE_YOU_WANT_TO_SURRENDER_EXP_PENALTY_WILL_BE_THE_SAME_AS_DEATH = 1252; // Вы хотите сдаться? При капитуляции будет снято количество опыта, равное
																												// одной смерти.
	public static final int ARE_YOU_SURE_YOU_WANT_TO_SURRENDER_EXP_PENALTY_WILL_BE_THE_SAME_AS_DEATH_AND_YOU_WILL_NOT_BE_ALLOWED_TO_PARTICIPATE_IN_CLAN_WAR = 1253; // Вы хотите сдаться?
																																									// При капитуляции
																																									// будет снято
																																									// количество опыта,
																																									// равное одной
	...
	public static final int THE_SPECIAL_SKILL_OF_A_SERVITOR_OR_PET_CANNOT_BE_REGISTERED_AS_A_MACRO = 1257; // Особые умения питомцев и вызванных существ не могут быть сохранены как
																											// макросы.
	...
	public static final int SEVEN_SIGNS_THE_QUEST_EVENT_PERIOD_HAS_BEGUN_SPEAK_WITH_A_PRIEST_OF_DAWN_OR_DUSK_PRIESTESS_IF_YOU_WISH_TO_PARTICIPATE_IN_THE_EVENT = 1261; // Семь Печатей:
																																										// Ивент начался.
																																										// Поговорите со
																																										// Жрецом
																																										// Рассвета или
	...
	public static final int SEVEN_SIGNS_THIS_IS_THE_SEAL_VALIDATION_PERIOD_A_NEW_QUEST_EVENT_PERIOD_BEGINS_NEXT_MONDAY = 1263; // Семь Печатей: Период действия Печати. Следующий ивент
																																// будет проведен в следующий понедельник.
	...
	public static final int DO_YOU_WISH_TO_PARTICIPATE_UNTIL_THE_NEXT_SEAL_VALIDATION_PERIOD_YOU_ARE_A_MEMBER_OF_THE_LORDS_OF_DAWN = 1271; // Вы хотите участвовать? До следующего
																																			// периода действия Печати Вы будете состоять
																																			// в рядах Лордов Рассвета.
	public static final int DO_YOU_WISH_TO_PARTICIPATE_UNTIL_THE_NEXT_SEAL_VALIDATION_PERIOD_YOU_ARE_A_MEMBER_OF_THE_REVOLUTIONARIES_OF_DUSK = 1272; // Вы хотите участвовать? До
																																						// следующего действия Печати Вы
																																						// будете состоять в рядах
																																						// Мятежников Заката.
	...
	public static final int YOU_WILL_PARTICIPATE_IN_THE_SEVEN_SIGNS_AS_A_MEMBER_OF_THE_REVOLUTIONARIES_OF_DUSK = 1274; // Вы будете участвовать в Семи Печатях на стороне Мятежников
																														// Заката.
	...
	public static final int SINCE_THE_SEAL_WAS_OWNED_DURING_THE_PREVIOUS_PERIOD_AND_10_PERCENT_OR_MORE_PEOPLE_HAVE_VOTED = 1289; // Так как Вы обладали Печатью и проголосовало более 10%
																																	// людей
	public static final int ALTHOUGH_THE_SEAL_WAS_NOT_OWNED_SINCE_35_PERCENT_OR_MORE_PEOPLE_HAVE_VOTED = 1290; // Хотя Вы не обладали Печатью в прошлый раз, но проголосовало более 35%
																												// людей
	public static final int ALTHOUGH_THE_SEAL_WAS_OWNED_DURING_THE_PREVIOUS_PERIOD_BECAUSE_LESS_THAN_10_PERCENT_OF_PEOPLE_HAVE_VOTED = 1291; // Так как Вы обладали Печатью и
																																				// проголосовало менее 10% людей
	public static final int SINCE_THE_SEAL_WAS_NOT_OWNED_DURING_THE_PREVIOUS_PERIOD_AND_SINCE_LESS_THAN_35_PERCENT_OF_PEOPLE_HAVE_VOTED = 1292; // Хотя Вы не обладали печатью в прошлый
																																				// раз, но проголосовало менее 35% людей
	...
	public static final int DUE_TO_THE_INFLUENCE_OF_THE_SEAL_OF_STRIFE_ALL_DEFENSIVE_REGISTRATION_HAS_BEEN_CANCELED_EXCEPT_BY_ALLIANCES_OF_CASTLE_OWNING_CLANS = 1304; // Под влиянием
																																										// Печати Раздора
																																										// была отменена
																																										// регистрация
																																										// кланов-защитников
																																										// Печати.
	public static final int YOU_MAY_GIVE_SOMEONE_ELSE_A_SEAL_STONE_FOR_SAFEKEEPING_ONLY_DURING_A_QUEST_EVENT_PERIOD = 1305; // Камни Печатей могут быть переданы только во время
																															// квестового ивента.
	...
	public static final int THIS_OPTION_REQUIRES_THAT_THE_LATEST_VERSION_OF_MSN_MESSENGER_CLIENT_BE_INSTALLED_ON_YOUR_COMPUTER = 1309; // Для использования данной функции вам необходимо
																																		// установить последнюю версию службы сообщений
																																		// MSN.
	public static final int FOR_FULL_FUNCTIONALITY_THE_LATEST_VERSION_OF_MSN_MESSENGER_CLIENT_MUST_BE_INSTALLED_ON_THE_USERS_COMPUTER = 1310; // Чтобы воспользоваться функциями службы
																																				// сообщений MSN в игре, необходимо
																																				// установить последнюю версию MSN
																																				// Messenger.
	public static final int PREVIOUS_VERSIONS_OF_MSN_MESSENGER_ONLY_PROVIDE_THE_BASIC_FEATURES_TO_CHAT_IN_THE_GAME_ADD_DELETE_CONTACTS_AND_OTHER_OPTIONS_ARENT_AVAILABLE = 1311; // Если
																																													...
																																													// не
																																													// сможете.
	public static final int THE_LATEST_VERSION_OF_MSN_MESSENGER_MAY_BE_OBTAINED_FROM_THE_MSN_WEB_SITE_ = 1312; // Для установки последней версии службы сообщений MSN посетите сайт
	...
	public static final int AFTER_SELECTING_THE_GROUP_YOU_WISH_TO_MOVE_YOUR_CONTACT_TO_PRESS_THE_OK_BUTTON = 1320; // Выбрав группу, в которую хотите поместить контакт, нажмите кнопку
																													// "ОК".
	...
	public static final int YOUVE_LOGGED_INTO_ANOTHER_COMPUTER_AND_BEEN_LOGGED_OUT_OF_THE_NET_MESSENGER_SERVICE_ON_THIS_COMPUTER = 1325; // Вы вошли на другом компьютере, поэтому
																																			// произошел выход из .NET Messenger Service.
	...
	public static final int YOU_ARE_CURRENTLY_BANNED_FROM_ACTIVITIES_RELATED_TO_THE_PRIVATE_STORE_AND_PRIVATE_WORKSHOP = 1329; // Вы не можете воспользоваться функциями личной торговой
																																// лавки и мастерской.
	...
	public static final int ACTIVITIES_RELATED_TO_THE_PRIVATE_STORE_AND_PRIVATE_WORKSHOP_ARE_NOW_PERMITTED = 1331; // Блокировка на пользование личной торговой лавкой и мастерской
																													// снята.
	...
	public static final int ONCE_A_MACRO_IS_ASSIGNED_TO_A_SHORTCUT_IT_CANNOT_BE_RUN_AS_A_MACRO_AGAIN = 1339; // Если макрос используется как клавиша ярлыков, воспользоваться им снова
																												// нельзя.
	...
	public static final int THE_PASSWORD_OR_E_MAIL_ADDRESS_YOU_ENTERED_IS_INCORRECT__YOUR_ATTEMPT_TO_LOG_INTO_NET_MESSENGER_SERVICE_HAS_FAILED = 1343; // Вы ввели неверный пароль или
																																						// электронный адрес, поэтому
																																						// подключиться к .NET Messenger
																																						// Service нельзя.
	...
	public static final int THE_STATUS_WILL_BE_CHANGED_TO_INDICATE__OFF_LINE__ALL_THE_CHAT_WINDOWS_CURRENTLY_OPENED_WILL_BE = 1350; // Вы изменили статус на "Отключен". Все окна будут
																																	// закрыты.
	...
	public static final int YOU_CAN_SET_THE_OPTION_TO_SHOW_YOUR_STATUS_AS_ALWAYS_BEING_OFF_LINE_TO_ALL_OF_YOUR_CONTACTS = 1353; // Вы можете сменить статус на "Отключен" для всех
																																// контактов в списке.
	...
	public static final int ARE_YOU_SURE_YOU_WANT_TO_CHOOSE_THIS_WEAPON_TO_FULFILL_THE_QUEST_YOU_MUST_BRING_THE_CHOSEN_WEAPON = 1382; // Вы хотите выбрать это оружие? Чтобы завершить
																																		// квест, вы должны принести выбранное оружие.
	...
	public static final int THE_LIST_OF_PARTY_ROOMS_CAN_BE_VIEWED_BY_A_PERSON_WHO_HAS_NOT_JOINED_A_PARTY_OR_WHO_IS_A_PARTY_LEADER = 1396; // Вы не входите в группу, или доступом к
																																			// списку комнаты группы обладает только ее
																																			// лидер.
	...
	public static final int YOU_ARE_USING_A_COMPUTER_THAT_DOES_NOT_ALLOW_YOU_TO_LOG_IN_WITH_TWO_ACCOUNTS_AT_THE_SAME_TIME = 1407; // Вы пользуетесь компьютером, двойной вход с которого
																																	// запрещен.
	public static final int YOUR_PREPAID_REMAINING_USAGE_TIME_IS_S1_HOURS_AND_S2_MINUTES__YOU_HAVE_S3_PAID_RESERVATIONS_LEFT = 1408; // Предоплаченное время: $s1ч $s2мин. Осталось
																																		// оплаченных чеков: $s3.
	public static final int YOUR_PREPAID_USAGE_TIME_HAS_EXPIRED_YOUR_NEW_PREPAID_RESERVATION_WILL_BE_USED_THE_REMAINING_USAGE_TIME_IS_S1_HOURS_AND_S2_MINUTES = 1409; // Предоплаченное
																																										...
																																										// время: $s1 ч
																																										// $s2 мин.
	public static final int YOUR_PREPAID_USAGE_TIME_HAS_EXPIRED_YOU_DO_NOT_HAVE_ANY_MORE_PREPAID_RESERVATIONS_LEFT = 1410; // Предоплаченное время закончилось. Предоплаченных чеков не
																															// осталось.
	...
	public static final int Untrain_of_enchant_skill_was_successful_Current_level_of_enchant_skill_S1_has_been_decreased_by_1 = 2069; // Разучивание умения улучшения успешно завершено.
																																		// Текущий уровень умения $s1 был понижен на 1.
	public static final int Untrain_of_enchant_skill_was_successful_Current_level_of_enchant_skill_S1_became_0_and_enchant_skill_will_be_initialized = 2070; // Сброс улучшений умения
																																								// завершен. $s1: текущий
																																								// уровень - 0, умение
	...
	public static final int Enchant_skill_route_change_was_successful_Lv_of_enchant_skill_S1_has_been_decreased_by_S2 = 2072; // Путь улучшения умения был изменен. Уровень умения $s1
																																// был понижен на $s2.
	...
	public static final int YOUR_PREVIOUS_SUB_CLASS_WILL_BE_DELETED_AND_YOUR_NEW_SUB_CLASS_WILL_START_AT_LEVEL_40__DO_YOU_WISH_TO_PROCEED = 1445; // Предыдущий подкласс будет заменен
																																					// новым по достижении 40-го уровня.
																																					// Продолжить?
	...
	public static final int THE_GAME_HAS_BEEN_CANCELLED_BECAUSE_THE_OTHER_PARTY_DOES_NOT_MEET_THE_REQUIREMENTS_FOR_JOINING_THE_GAME = 1494; // Противник не соответствовал условиям
																																			// участия в соревновании, поэтому
	...
	public static final int S1_IS_MAKING_AN_ATTEMPT_AT_RESURRECTION_WITH_$S2_EXPERIENCE_POINTS_DO_YOU_WANT_TO_CONTINUE_WITH_THIS_RESURRECTION = 1510; // $c1 пробует восстановить
																																						// утерянный опыт персонажа $s2.
																																						// Вы согласны?
	...
	public static final int SINCE_THE_PET_WAS_IN_THE_PROCESS_OF_BEING_RESURRECTED_THE_ATTEMPT_TO_RESURRECT_ITS_MASTER_HAS_BEEN_CANCELLED = 1514; // Нельзя воскресить хозяина, так как в
																																					// данный момент воскрешается
																																					// питомец.
	public static final int SINCE_THE_MASTER_WAS_IN_THE_PROCESS_OF_BEING_RESURRECTED_THE_ATTEMPT_TO_RESURRECT_THE_PET_HAS_BEEN_CANCELLED = 1515; // Нельзя воскресить питомца, так как в
																																					// данный момент воскрешается хозяин.
	...
	public static final int THE_PET_HAS_BEEN_KILLED_IF_YOU_DO_NOT_RESURRECT_IT_WITHIN_24_HOURS_THE_PETS_BODY_WILL_DISAPPEAR_ALONG_WITH_ALL_THE_PETS_ITEMS = 1519; // Питомец умер. Если
																																									// не возродить
																																									// питомца в течение
																																									// 24 ч, то труп и
																																									// все предметы
	...
	public static final int BECAUSE_PET_OR_SERVITOR_MAY_BE_DROWNED_WHILE_THE_BOAT_MOVES_PLEASE_RELEASE_THE_SUMMON_BEFORE_DEPARTURE = 1523; // Во время движения корабля питомец или слуга
																																			// может упасть за борт и умереть.
																																			// Пожалуйста, уберите ваших питомцев.
	...
	public static final int CLAN_WAR_HAS_BEEN_DECLARED_AGAINST_S1_CLAN_IF_YOU_ARE_KILLED_DURING_THE_CLAN_WAR_BY_MEMBERS_OF_THE_OPPOSING_CLAN_THE_EXPERIENCE_PENALTY_WILL_BE_REDUCED_TO_1_4_OF_NORMAL = 1562; // Вы
																																																				...
																																																				// составит
																																																				// 1/4.
	public static final int S1_CLAN_CANT_MAKE_A_DECLARATION_OF_CLAN_WAR_SINCE_IT_HASNT_REACHED_THE_CLAN_LEVEL_OR_DOESNT_HAVE_ENOUGH_CLAN_MEMBERS = 1563; // У клана $s1 неподходящий
																																							// уровень или слишком малое
																																							// количество человек в
																																							// клане. Объявить ему войну
																																							// нельзя.
	public static final int A_CLAN_WAR_CAN_BE_DECLARED_ONLY_IF_THE_CLAN_IS_LEVEL_THREE_OR_ABOVE_AND_THE_NUMBER_OF_CLAN_MEMBERS_IS_FIFTEEN_OR_GREATER = 1564; // Вы можете объявлять войну
																																								// только в том случае,
																																								// если уровень вашего
																																								// клана больше 3 и в
																																								// игре находятся более
																																								// 15 человек.
	public static final int THE_DECLARATION_OF_WAR_CANT_BE_MADE_BECAUSE_THE_CLAN_DOES_NOT_EXIST_OR_ACT_FOR_A_LONG_PERIOD = 1565; // Невозможно объявить войну этому клану. Этого клана не
																																	// существует или он долгое время не принимает
																																	// участия в игре.
	...
	public static final int COMMAND_CHANNELS_CAN_ONLY_BE_FORMED_BY_A_PARTY_LEADER_WHO_IS_ALSO_THE_LEADER_OF_A_LEVEL_5_CLAN = 1575; // Канал команды может быть создан только лидером
																																	// группы, который также является главой клана
																																	// уровнем не менее 5.
	...
	public static final int THE_COMMAND_CHANNEL_IS_ACTIVATED_ONLY_IF_AT_LEAST_FIVE_PARTIES_PARTICIPATE_IN = 1588; // Канал команды активируется только в том случае, если в нем находится
																													// более 5 групп.
	...
	public static final int WHEN_PET_OR_SERVITOR_IS_DEAD_SOULSHOTS_OR_SPIRITSHOTS_FOR_PET_OR_SERVITOR_ARE_NOT_AVAILABLE = 1598; // Если питомец/слуга умер, нельзя использовать Заряды
																																// Души и Духа.
	...
	public static final int WHILE_DRESSED_IN_FORMAL_WEAR_YOU_CANT_USE_ITEMS_THAT_REQUIRE_ALL_SKILLS_AND_CASTING_OPERATIONS = 1604; // В свадебных нарядах нельзя использовать предметы,
																																	// которые задействуют все умения и магию.
	public static final int _HERE_YOU_CAN_BUY_ONLY_SEEDS_OF_S1_MANOR = 1605; // *Здесь можно купить только семена владения $s1.
	public static final int YOU_HAVE_COMPLETED_THE_QUEST_FOR_3RD_OCCUPATION_CHANGE_AND_MOVED_TO_ANOTHER_CLASS_CONGRATULATIONS = 1606; // Поздравляем! Вы завершили квест на третью смену
																																		// профессии.
	...
	public static final int THE_FERRY_FROM_RUNE_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_15_MINUTES = 1630; // Корабль, отплывший из гавани Руны, прибудет в гавань
																																// Глудина через 15 минут.
	public static final int THE_FERRY_FROM_RUNE_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_10_MINUTES = 1631; // Корабль, отплывший из гавани Руны, прибудет в гавань
																																// Глудина через 10 минут.
	public static final int THE_FERRY_FROM_RUNE_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_5_MINUTES = 1632; // Корабль, отплывший из гавани Руны, прибудет в гавань
																															// Глудина через 5 минут.
	public static final int THE_FERRY_FROM_RUNE_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPROXIMATELY_1_MINUTE = 1633; // Корабль, отплывший из гавани Руны, прибудет в гавань
																															// Глудина через 1 минуту.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPROXIMATELY_15_MINUTES = 1634; // Корабль, отплывший из гавани Руны, прибудет в гавань
																																// Глудина через 15 минут.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPROXIMATELY_10_MINUTES = 1635; // Корабль, отплывший из гавани Руны, прибудет в гавань
																																// Глудина через 10 минут.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPROXIMATELY_5_MINUTES = 1636; // Корабль, отплывший из гавани Руны, прибудет в гавань
																															// Глудина через 5 минут.
	public static final int THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPROXIMATELY_1_MINUTE = 1637; // Корабль, отплывший из гавани Руны, прибудет в гавань
																															// Глудина через 1 минуту.
	public static final int YOU_CANNOT_FISH_WHILE_USING_A_RECIPE_BOOK_PRIVATE_MANUFACTURE_OR_PRIVATE_STORE = 1638; // Нельзя рыбачить во режимах личной торговой лавки, мастерской и
																													// книги рецептов.
	...
	public static final int SINCE_THE_SKILL_LEVEL_OF_REELING_PUMPING_IS_HIGHER_THAN_THE_LEVEL_OF_YOUR_FISHING_MASTERY_A_PENALTY_OF_S1_WILL_BE_APPLIED = 1670; // Умение «Подсечь»
																																								// («Подтянуть») на 3 или
																																								// более уровня выше
																																								// умения рыбной ловли.
	...
	public static final int THE_CURRENT_FOR_THIS_OLYMPIAD_IS_S1_WINS_S2_DEFEATS_S3_YOU_HAVE_EARNED_S4_OLYMPIAD_POINTS = 1673; // Ваш результат в Олимпиаде: матчей - $s1, побед - $s2,
																																// поражений - $s3. Получено баллов Олимпиады - $s4.
	...
	public static final int A_CEASE_FIRE_DURING_A_CLAN_WAR_CAN_NOT_BE_CALLED_WHILE_MEMBERS_OF_YOUR_CLAN_ARE_ENGAGED_IN_BATTLE = 1677; // Невозможно отменить войну из-за того, что в
																																		// данный момент члены клана вовлечены в битву.
	...
	public static final int WHILE_A_CLAN_IS_BEING_DISSOLVED_IT_IS_IMPOSSIBLE_TO_DECLARE_A_CLAN_WAR_AGAINST_IT = 1684; // Нельзя объявлять войну, если ваш клан находится в стадии
																														// расформирования.
	...
	public static final int THIS_AREA_CANNOT_BE_ENTERED_WHILE_MOUNTED_ATOP_OF_A_WYVERN_YOU_WILL_BE_DISMOUNTED_FROM_YOUR_WYVERN_IF_YOU_DO_NOT_LEAVE = 1687; // В этой зоне нельзя летать
																																							// на виверне. Если вы
																																							// останетесь на этой
																																							// территории, вам необходимо
																																							// спешиться с виверны.
	...
	public static final int YOU_ARE_ALREADY_ON_THE_WAITING_LIST_TO_PARTICIPATE_IN_THE_GAME_FOR_YOUR_CLASS = 1689; // $c1 уже состоит в списке ожидающих соревнования между
																													// представителями одной профессии.
	public static final int YOU_ARE_ALREADY_ON_THE_WAITING_LIST_FOR_ALL_CLASSES_WAITING_TO_PARTICIPATE_IN_THE_GAME = 1690; // $c1 уже состоит в списке ожидающих внеклассовые
																															// соревнования.
	public static final int SINCE_80_PERCENT_OR_MORE_OF_YOUR_INVENTORY_SLOTS_ARE_FULL_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD = 1691; // $c1 не может участвовать в Олимпиаде, так как
																																		// ячейки инвентаря заполнены на 80%.
	public static final int SINCE_YOU_HAVE_CHANGED_YOUR_CLASS_INTO_A_SUB_JOB_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD = 1692; // $c1 не может участвовать в Олимпиаде, так как класс
																															// изменен на подкласс.
	public static final int WHILE_YOU_ARE_ON_THE_WAITING_LIST_YOU_ARE_NOT_ALLOWED_TO_WATCH_THE_GAME = 1693; // Вы не можете наблюдать за Олимпиадой, когда вы состоите в списке
																											// участников.
	public static final int ONLY_A_CLAN_LEADER_THAT_IS_A_NOBLESSE_CAN_VIEW_THE_SIEGE_WAR_STATUS_WINDOW_DURING_A_SIEGE_WAR = 1694; // Во время войны это может использовать только глава
																																	// клана и только если он является дворянином.
	...
	public static final int PLEASE_CLOSE_THE_SETUP_WINDOW_FOR_A_PRIVATE_MANUFACTURING_STORE_OR_THE_SETUP_WINDOW_FOR_A_PRIVATE_STORE_AND_TRY_AGAIN = 1704; // Пожалуйста, закройте окно
																																							// настроек частной торговой
																																							// лавки/мастерской и
																																							// повторите попытку.
	// Pc Bang Points
	...
	public static final int SIEGE_WAR_ZONE___N__A_SIEGE_IS_CURRENTLY_IN_PROGRESS_IN_THIS_AREA____N_IF_A_CHARACTER_DIES_IN = 1717; // Зона Осады Замка \\n- Сейчас проходит осада замка.
																																	// \\n- Использование умения воскрешения может быть
																																	// ограничено.
	...
	public static final int TO_JOIN_A_CLAN_ACADEMY_CHARACTERS_MUST_BE_LEVEL_40_OR_BELOW_NOT_BELONG_ANOTHER_CLAN_AND_NOT_YET_COMPLETED_THEIR_2ND_CLASS_TRANSFER = 1734; // Для вступления
																																										// в академию
																																										// клана
																																										// персонажи
																																										// должны быть
	...
	public static final int THE_CLAN_ACADEMY_HAS_REACHED_ITS_MAXIMUM_ENROLLMENT = 1736; // Максимально допустимое кол-во персонажей в академии достигнуто. Больше нельзя принять
																						// персонажей в академию.
	...
	public static final int TO_OPEN_A_CLAN_ACADEMY_THE_LEADER_OF_A_LEVEL_5_CLAN_OR_ABOVE_MUST_PAY_XX_PROOFS_OF_BLOOD_OR_A_CERTAIN_AMOUNT_OF_ADENA = 1743; // Для создания академии клана
																																							// нужно, чтобы уровень клана
																																							// был не меньше 5 и глава
																																							// клана должен заплатить XX
																																							// Меток Крови или
																																							// определенную сумму аден.
	public static final int THERE_WAS_NO_RESPONSE_TO_YOUR_INVITATION_TO_JOIN_THE_CLAN_ACADEMY_SO_THE_INVITATION_HAS_BEEN_RESCINDED = 1744; // Нет ответа. Ваше приглашение на вступление
																																			// в академию клана было отменено.
	...
	public static final int S1_HAS_SENT_YOU_AN_INVITATION_TO_JOIN_THE_CLAN_ACADEMY_BELONGING_TO_THE_S2_CLAN_DO_YOU_ACCEPT = 1747; // $s1 присылает Вам приглашение на вступление в
																																	// Академию клана $s2. Принять?
	public static final int CLAN_ACADEMY_MEMBER_S1_HAS_SUCCESSFULLY_COMPLETED_THE_2ND_CLASS_TRANSFER_AND_OBTAINED_S2_CLAN_REPUTATION_POINTS = 1748; // $s1 из Академии клана успешно
																																					// получил 2-ю профессию. Клан
																																					// получил очки репутации ($s2).
	public static final int CONGRATULATIONS_YOU_WILL_NOW_GRADUATE_FROM_THE_CLAN_ACADEMY_AND_LEAVE_YOUR_CURRENT_CLAN_AS_A_GRADUATE_OF_THE_ACADEMY_YOU_CAN_IMMEDIATELY_JOIN_A_CLAN_AS_A_REGULAR_MEMBER_WITHOUT_BEING_SUBJECT_TO_ANY_PENALTIES = 1749; // Поздравляем!
																																																													...
																																																													// в
																																																													// клан.
	public static final int C1_DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_THE_OWNER_OF_S2_CANNOT_PARTICIPATE_IN_THE = 1750; // $c1 не может участвовать в соревнованиях, так как
																																// обладатель территорией $s2 не может участвовать в
																																// Олимпиаде.
	...
	public static final int SINCE_THE_CLAN_HAS_RECEIVED_A_GRADUATE_OF_THE_CLAN_ACADEMY_IT_HAS_EARNED_S1_POINTS_TOWARD_ITS_REPUTATION_SCORE = 1752; // Приняв выпускника академии в клан,
																																					// Вы получаете $s1 очков репутации
																																					// клана.
	public static final int THE_CLAN_LEADER_HAS_DECREED_THAT_THAT_PARTICULAR_PRIVILEGE_CANNOT_BE_GRANTED_TO_A_CLAN_ACADEMY = 1753; // Невозможно уполномочить этими правами ученика
																																	// академии, так как глава клана ограничил передачу
																																	// этих прав.
	...
	public static final int C1_HAS_SENT_YOU_AN_INVITATION_TO_JOIN_THE_S3_ORDER_OF_KNIGHTS_UNDER_THE_S2_CLAN_WOULD_YOU_LIKE = 1769; // $c1 из клана $s2 приглашает Вас вступить в Орден
																																	// Рыцарей $s3.
	public static final int THE_CLAN_REPUTATION_SCORE_HAS_DROPPED_BELOW_0_THE_CLAN_MAY_FACE_CERTAIN_PENALTIES_AS_A_RESULT = 1770; // При снижении очков репутации ниже 0 на клан могут
																																	// быть наложены некоторые санкции.
	...
	public static final int SINCE_YOUR_CLAN_WAS_DEFEATED_IN_A_SIEGE_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE_AND_GIVEN_TO_THE_OPPOSING_CLAN = 1772; // Ваш клан
																																										// проиграл осаду
																																										// замка.
																																										// Потеряно очков
																																										// клана: $s1.
	public static final int SINCE_YOUR_CLAN_EMERGED_VICTORIOUS_FROM_THE_SIEGE_S1_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE = 1773; // Ваш клан выиграл осаду замка. Получено
																																				// очков клана: $s1.
	public static final int YOUR_CLAN_NEWLY_ACQUIRED_CONTESTED_CLAN_HALL_HAS_ADDED_S1_POINTS_TO_YOUR_CLAN_REPUTATION_SCORE = 1774; // Ваш клан заново завоевал холл клана. Получено очков
																																	// клана: $s1.
	public static final int CLAN_MEMBER_S1_WAS_AN_ACTIVE_MEMBER_OF_THE_HIGHEST_RANKED_PARTY_IN_THE_FESTIVAL_OF_DARKNESS_S2_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE = 1775; // Член
																																														...
																																														// клана:
																																														// $s2.
	public static final int CLAN_MEMBER_S1_WAS_NAMED_A_HERO_2S_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE = 1776; // Член клана получил статус героя. Получено очков клана:
																															// $2s.
	public static final int YOU_HAVE_SUCCESSFULLY_COMPLETED_A_CLAN_QUEST_S1_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE = 1777; // Вы успешно выполнили клановый квест. Получено
																																			// очков клана: $s1.
	public static final int AN_OPPOSING_CLAN_HAS_CAPTURED_YOUR_CLAN_CONTESTED_CLAN_HALL_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE = 1778; // Враждебный клан захватил
																																								// ваш спорный холл.
																																								// Потеряно очков клана:
																																								// $s1.
	public static final int AFTER_LOSING_THE_CONTESTED_CLAN_HALL_300_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE = 1779; // После потери спорного холла клана 300 очков
																																		// будет вычтено из репутации вашего клана.
	public static final int YOUR_CLAN_HAS_CAPTURED_YOUR_OPPONENT_CONTESTED_CLAN_HALL_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_OPPONENT_CLAN_REPUTATION_SCORE = 1780; // Ваш клан захватил
																																									// спорный холл
																																									// враждебного клана.
																																									// Потеряно очков
																																									// клана противника:
	...
	public static final int YOUR_CLAN_MEMBER_S1_WAS_KILLED_S2_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE_AND_ADDED_TO_YOUR_OPPONENT_CLAN_REPUTATION_SCORE = 1782; // Член
																																													...
																																													// противнику:
																																													// $s2.
	public static final int FOR_KILLING_AN_OPPOSING_CLAN_MEMBER_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_OPPONENTS_CLAN_REPUTATION_SCORE = 1783; // За убийство члена враждебного клана из
																																				// клановой репутации противника вычтено
																																				// очков клана: $s1.
	public static final int YOUR_CLAN_HAS_FAILED_TO_DEFEND_THE_CASTLE_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE_AND_ADDED_TO_YOUR_OPPONENTS = 1784; // Ваш клан не
																																										// смог защитить
																																										// замок.
																																										// Потеряно очков
																																										// клана и
																																										...
																																										// противнику:
																																										// $s1.
	public static final int THE_CLAN_YOU_BELONG_TO_HAS_BEEN_INITIALIZED_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE = 1785; // Ваш клан был возвращен в исходное
																																				// состояние. Потеряно очков клана: $s1.
	public static final int YOUR_CLAN_HAS_FAILED_TO_DEFEND_THE_CASTLE_S1_POINTS_HAVE_BEEN_DEDUCTED_FROM_YOUR_CLAN_REPUTATION_SCORE = 1786; // Ваш клан не смог защитить замок. Потеряно
																																			// очков клана: $s1.
	...
	public static final int SINCE_THE_CLAN_REPUTATION_SCORE_HAS_DROPPED_TO_0_OR_LOWER_YOUR_CLAN_SKILLS_WILL_BE_DE_ACTIVATED = 1789; // С момента падения клановой репутации до 0 и ниже
																																	// ваши клановые умения будут заблокированы.
	...
	public static final int FOR_KOREA_ONLY = 1796; // Ваш аккаунт временно заблокирован за воровство аккаунтов или другую вредоносную деятельность. За дополнительной информацией
	...
	public static final int THIS_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_7_DAYS = 1804; // Ваш аккаунт заблокирован на 7 дней, так как он был замечен в нелегальных денежных сделках. За
																				// дополнительной информацией обратитесь в Центр Поддержки.
	public static final int THIS_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_30_DAYS_1 = 1805; // Ваш аккаунт заблокирован на 30 дней, так как он был повторно замечен в нелегальных денежных сделках.
																					// За дополнительной информацией обратитесь в Центр Поддержки.
	public static final int THIS_ACCOUNT_HAS_BEEN_PERMANENTLY_BANNED_1 = 1806; // Ваш аккаунт бессрочно заблокирован, так как он был в третий раз замечен в нелегальных денежных сделках.
																				// За дополнительной информацией обратитесь в Центр Поддержки.
	public static final int THIS_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_30_DAYS_2 = 1807; // Ваш аккаунт заблокирован на 30 дней, так как вы замешаны в нелегальных денежных операциях. За
																					// дополнительной информацией обратитесь в Центр Поддержки.
	public static final int THIS_ACCOUNT_HAS_BEEN_PERMANENTLY_BANNED_2 = 1808; // Ваш аккаунт бессрочно заблокирован, так как вы замешаны в нелегальных денежных операциях. За
																				// дополнительной информацией обратитесь в Центр Поддержки.
	public static final int ACCOUNT_OWNER_MUST_BE_VERIFIED_IN_ORDER_TO_USE_THIS_ACCOUNT_AGAIN = 1809; // Ваш аккаунт, вероятно, проверяется. За информацией о процедуре проверки
																										// аккаунтов обращайтесь в Центр Поддержки.
	...
	public static final int SINCE_THE_REFUSE_INVITATION_STATE_IS_CURRENTLY_ACTIVATED_NO_INVITATION_CAN_BE_MADE = 1812; // С момента активации статуса отказа от приглашений не могут быть
																														// сделаны приглашения.
	...
	public static final int YOU_HAVE_BEEN_REGISTERED_FOR_A_CLAN_HALL_WAR__PLEASE_MOVE_TO_THE_LEFT_SIDE_OF_THE_CLAN_HALL_S = 1824; // Вы зарегистрировались для войны за холл клана.
																																	// Пожалуйста, проследуйте на левый край арены холла
																																	// клана и приготовьтесь.
	public static final int YOU_HAVE_FAILED_IN_YOUR_ATTEMPT_TO_REGISTER_FOR_THE_CLAN_HALL_WAR_PLEASE_TRY_AGAIN = 1825; // Ваша попытка зарегистрироваться для войны за холл клана не
																														// удалась. Пожалуйста, попытайтесь снова.
	public static final int IN_S1_MINUTES_THE_GAME_WILL_BEGIN_ALL_PLAYERS_MUST_HURRY_AND_MOVE_TO_THE_LEFT_SIDE_OF_THE_CLAN = 1826; // Игра начнется через $s1 мин. Все игроки должны
																																	// поспешить и отойти на левый край арены холла
																																	// клана.
	...
	public static final int C1_IS_NOT_ALLOWED_TO_USE_THE_PARTY_ROOM_INVITE_COMMAND_PLEASE_UPDATE_THE_WAITING_LIST = 1830; // $c1 не может использовать команду приглашения в комнату
																															// группы. Пожалуйста, обновите лист ожидания.
	public static final int C1_DOES_NOT_MEET_THE_CONDITIONS_OF_THE_PARTY_ROOM_PLEASE_UPDATE_THE_WAITING_LIST = 1831; // $c1 не соответствует условиям комнаты группы. Пожалуйста,
																														// обновите лист ожидания.
	...
	public static final int YOU_CANNOT_JOIN_A_CLAN_ACADEMY_BECAUSE_YOU_HAVE_SUCCESSFULLY_COMPLETED_YOUR_2ND_CLASS_TRANSFER = 1836; // Вы не можете присоединиться к Академии Клана, так
																																	// как уже выполнили квест на вторую смену профессии.
	public static final int C1_HAS_SENT_YOU_AN_INVITATION_TO_JOIN_THE_S3_ROYAL_GUARD_UNDER_THE_S2_CLAN_WOULD_YOU_LIKE_TO = 1837; // $c1 приглашает Вас вступить в отряд Королевской
																																	// Стражи $s3 клана $s2. Принять?
	...
	public static final int _3_IF_YOU_ENTER_THE_INCORRECT_SERIAL_NUMBER_MORE_THAN_5_TIMES__N___YOU_MAY_USE_IT_AGAIN_AFTER_A = 1840; // Если Вы ввели неверный серийный номер более 5-ти
																																	// раз, \\n то сможете ввести его снова только спустя
																																	// некоторое время.
	public static final int THIS_CLAN_HALL_WAR_HAS_BEEN_CANCELLED__NOT_ENOUGH_CLANS_HAVE_REGISTERED = 1841; // Эта война за холл клана была отменена из-за недостаточного количества
	...
	public static final int THE_ATTEMPT_TO_ACQUIRE_THE_SKILL_HAS_FAILED_BECAUSE_OF_AN_INSUFFICIENT_CLAN_REPUTATION_SCORE = 1852; // Попытка получить умение не удалась из-за
																																	// недостаточного количества Очков Репутации Клана.
	...
	public static final int ANOTHER_MILITARY_UNIT_IS_ALREADY_USING_THAT_NAME_PLEASE_ENTER_A_DIFFERENT_NAME = 1855; // Это имя уже используется боевым подразделением. Назначьте другое
																													// имя.
	...
	public static final int YOU_HAVE_EXCEEDED_THE_QUANTITY_THAT_CAN_BE_MOVED_AT_ONE_TIME = 1859; // Вы превысили максимальное количество предметов, которое может быть перемещено за один
																									// раз.
	...
	public static final int THE_CLAN_SKILL_WILL_BE_ACTIVATED_BECAUSE_THE_CLANS_REPUTATION_SCORE_HAS_REACHED_TO_0_OR_HIGHER = 1862; // С того момента, как количество очков репутации
																																	// стало 0 или выше, клановые умение активны.
	...
	public static final int S1_HAS_GRANTED_THE_CHANNELS_MASTER_PARTY_THE_PRIVILEGE_OF_ITEM_LOOTING = 1869; // $c1 наделяется полномочиями сбора предметов главной группой Командного
																											// Канала.
	...
	public static final int THIS_SERIAL_NUMBER_CANNOT_BE_ENTERED_PLEASE_TRY_AGAIN_IN_S1_MINUTES = 1885; // Серийный номер сейчас не может быть введен. Пожалуйста, повторите попытку
																										// через $s1 мин.
	public static final int THIS_SERIAL_NUMBER_HAS_ALREADY_BEEN_USED = 1886; // Этот серийный номер уже использован.
	public static final int INVALID_SERIAL_NUMBER_YOUR_ATTEMPT_TO_ENTER_THE_NUMBER_HAS_FAILED_S1_TIMES_YOU_WILL_BE_ALLOWED_TO_MAKE_S2_MORE_ATTEMPTS = 1887; // Неверный серийный номер.
																																							// Ваша попытка ввести номер
																																							// не удалась $s1 раз(-а). Вы
																																							// можете попытаться еще $s2
																																							// раз(-а).
	public static final int INVALID_SERIAL_NUMBER_YOUR_ATTEMPT_TO_ENTER_THE_NUMBER_HAS_FAILED_5_TIMES_PLEASE_TRY_AGAIN_IN_4_HOURS = 1888; // Неверный серийный номер. Ваша попытка ввести
																																			// номер не удалась 5 раз. Пожалуйста,
																																			// повторите попытку через 4 часа.
	...
	public static final int A_SUB_CLASS_CANNOT_BE_CREATED_OR_CHANGED_WHILE_YOU_ARE_OVER_YOUR_WEIGHT_LIMIT = 1894; // Подкласс не может быть создан или изменен, если вы превышаете лимит
																													// веса.
	...
	public static final int S1_IS_CURRENTLY_TRADING_OR_OPERATING_A_PRIVATE_STORE_AND_CANNOT_BE_SUMMONED = 1898; // Персонаж $c1 сейчас находится в личной торговой лавке и не может быть
																												// призван.
	...
	public static final int A_SUB_CLASS_MAY_NOT_BE_CREATED_OR_CHANGED_WHILE_A_SERVITOR_OR_PET_IS_SUMMONED = 1904; // Подкласс не может быть создан или изменен, если вызван слуга или
																													// питомец.
	...
	public static final int YOU_CANNOT_SUMMON_PLAYERS_WHO_ARE_CURRENTLY_PARTICIPATING_IN_THE_GRAND_OLYMPIAD = 1911; // Вы не можете призывать персонажей, в данное время участвующих в
																													// Великой Олимпиаде.
	...
	public static final int YOUR_ACCOUNT_IS_CURRENTLY_INACTIVE_BECAUSE_YOU_HAVE_NOT_LOGGED_INTO_THE_GAME_FOR_SOME_TIME_YOU = 1920; // Ваш аккаунт сейчас неактивен, поскольку вы долгое
																																	// время не посещали игру. Можно активировать на
																																	// нашем сайте.
	...
	public static final int YOU_CANNOT_PROCEED_BECAUSE_THE_MANOR_CANNOT_ACCEPT_ANY_MORE_CROPS__ALL_CROPS_HAVE_BEEN_RETURNED = 2014; // Неосуществимо. Владение не может принять больше
																																	// ростков. Все ростки были возвращены и в резерве не
																																	// осталось аден.
	...
	public static final int A_SUB_CLASS_CANNOT_BE_CREATED_OR_CHANGED_BECAUSE_YOU_HAVE_EXCEEDED_YOUR_INVENTORY_LIMIT = 2033; // Подкласс не может быть создан или изменен, поскольку Вы
																															// превысили ваш лимит инвентаря.
	...
	public static final int UNABLE_TO_CREATE_CHARACTER_YOU_ARE_UNABLE_TO_CREATE_A_NEW_CHARACTER_ON_THE_SELECTED_SERVER_A = 2037; // Невозможно создать персонажа на выбранном сервере.
																																	// Действует ограничение, не позволяющее
																																	// пользователям создавать персонажей на различных
																																	// серверах, где до этого не было создано персонажей.
	...
	public static final int THIS_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_NON_PAYMENT_BASED_ON_THE_CELL_PHONE_PAYMENT_AGREEMENT__N = 2042; // Этот аккаунт был заблокирован за неуплату в
																																	// соответствии с соглашением об оплате через
																																	// телефон. \\n Пожалуйста, пришлите подтверждение
																																	// оплаты и свяжитесь с центром обслуживания
																																	// клиентов.
	public static final int YOU_HAVE_EXCEEDED_YOUR_INVENTORY_VOLUME_LIMIT_AND_MAY_NOT_TAKE_THIS_QUEST_ITEM_PLEASE_MAKE_ROOM = 2043; // Вы превысили лимит объема вашего инвентаря и не
																																	// можете взять квестовый предмет. Освободите место в
																																	// инвентаре и возвращайтесь.
	...
	public static final int SOME_LINEAGE_II_FEATURES_HAVE_BEEN_LIMITED_FOR_FREE_TRIALS_TRIAL_ACCOUNTS_ARENT_ALLOWED_TO_USE = 2045; // Этот аккаунт не может использовать личную
																																	// мастерскую.
	...
	public static final int THE_SHORTCUT_IN_USE_CONFLICTS_WITH_S1_DO_YOU_WISH_TO_RESET_THE_CONFLICTING_SHORTCUTS_AND_USE_THE = 2048; // Ярлык конфликтует с $s1. Хотите сбросить
																																		// конфликтующий ярлык и использовать
																																		// сохраненный?
	...
	public static final int YOU_MUST_ACCEPT_THE_USER_AGREEMENT_BEFORE_THIS_ACCOUNT_CAN_ACCESS_LINEAGE_II__N_PLEASE_TRY_AGAIN = 2051; // Чтобы получить доступ в Lineage II, Вы должны
																																		// принять пользовательское соглашение. \\n
																																		// Пожалуйста, попробуйте еще раз.
	public static final int A_GUARDIAN_S_CONSENT_IS_REQUIRED_BEFORE_THIS_ACCOUNT_CAN_BE_USED_TO_PLAY_LINEAGE_II__NPLEASE_TRY = 2052; // Аккаунт будет допущен к игре в Lineage II только
																																		// после принятия соглашения о безопасности. \\n
																																		// Повторите попытку после принятия соглашения.
	public static final int THIS_ACCOUNT_HAS_DECLINED_THE_USER_AGREEMENT_OR_IS_PENDING_A_WITHDRAWL_REQUEST___NPLEASE_TRY = 2053; // Этот аккаунт отклонил пользовательское соглашение или
																																	// запросил отклонение.\\n Пожалуйста, повторите
																																	// попытку после отклонения запроса.
	public static final int THIS_ACCOUNT_HAS_BEEN_SUSPENDED___NFOR_MORE_INFORMATION_PLEASE_CALL_THE_CUSTOMER_S_CENTER_TEL = 2054; // Действие этого аккаунта приостановлено. \\n За
																																	// дополнительной информацией обращайтесь в Службу
	...
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FROM_ALL_GAME_SERVICES__NFOR_MORE_INFORMATION_PLEASE_VISIT_THE = 2055; // Ваш аккаунт отключен от всех игровых услуг. \\n За
																																	// дополнительной информацией обращайтесь в Службу
																																	// Поддержки Пользователей.
	public static final int YOUR_ACCOUNT_HAS_BEEN_CONVERTED_TO_AN_INTEGRATED_ACCOUNT_AND_IS_UNABLE_TO_BE_ACCESSED___NPLEASE = 2056; // Ваш аккаунт был преобразован в объединенный
																																	// аккаунт и не может выбран. \\n Пожалуйста,
																																	// пройдите регистрацию объединенным аккаунтом.
	...
	public static final int SEARCH_ON_USER_C2_FOR_THIRD_PARTY_PROGRAM_USE_WILL_BE_COMPLETED_IN_S1_MINUTES = 2086; // Поиск пользователя $c2, использующего сторонние программы,
																													// завершится через $s1 мин.
	public static final int YOUR_ACCOUNT_CAN_ONLY_BE_USED_AFTER_CHANGING_YOUR_PASSWORD_AND_QUIZ___N_SERVICES_WILL_BE = 2091; // Ваш аккаунт может использоваться только после смены
																																// пароля и контрольного вопроса.
	...
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_10_DAYS_FOR_USE_OF_ILLEGAL_SOFTWARE_AND_MAY_BE_PERMANENTLY = 2108; // Ваш аккаунт заблокирован на 10 дней за
																																	// использование нелицензионного программного
																																	// обеспечения и может быть заблокирован бессрочно.
																																	// За дополнительной информацией обратитесь в центр
																																	// поддержки.
	public static final int THE_SERVER_HAS_BEEN_INTEGRATED_AND_YOUR_CHARACTER_S1_HAS_BEEN_OVERLAPPED_WITH_ANOTHER_NAME = 2109; // Сервер был объединен и имя вашего персонажа было
																																// перекрыто другим персонажем. Пожалуйста, введите новое
																																// имя вашего персонажа.
	public static final int THIS_CHARACTER_NAME_ALREADY_EXISTS_OR_IS_AN_INVALID_NAME_PLEASE_ENTER_A_NEW_NAME = 2110; // Имя персонажа уже существует либо это некорректное имя.
																														// Пожалуйста, введите другое имя.
	public static final int ENTER_A_SHORTCUT_TO_ASSIGN = 2111; // Назначьте ярлык.
	public static final int SUB_KEY_CAN_BE_CTRL_ALT_SHIFT_AND_YOU_MAY_ENTER_TWO_SUB_KEYS_AT_A_TIME___N_EXAMPLE__CTRL___ALT__ = 2112; // Вспомогательными клавишами могут быть CTRL, ALT,
																																		// SHIl2f. Вы можете нажимать две одновременно.
																																		// Например, "CTRL + ALT + A"
	public static final int CTRL_ALT_SHIFT_KEYS_MAY_BE_USED_AS_SUB_KEY_IN_EXPANDED_SUB_KEY_MODE_AND_ONLY_ALT_MAY_BE_USED_AS = 2113; // Клавиши CTRL, ALT, SHIFT могут быть использованы в
																																	// расширенном режиме вспомогательных клавиш, и
																																	// только ALT может быть использован как
																																	// вспомогательная клавиша в стандартном режиме.
	public static final int FORCED_ATTACK_AND_STAND_IN_PLACE_ATTACKS_ASSIGNED_PREVIOUSLY_TO_CTRL_AND_SHIFT_WILL_BE_CHANGED = 2114; // Силовая и останавливающая атака, прежде назначенная
																																	// на Ctrl и Shift, при установке расширенного режима
																																	// ярлыков будет переназначена на Alt + Q и Alt + E.
																																	// Ctrl и Shift освободятся для установки других
																																	// быстрых доступов. Продолжить?
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_ABUSING_A_BUG_RELATED_TO_THE_NCCOIN_FOR_MORE_INFORMATION = 2115; // Ваш аккаунт заблокирован за использование ошибки,
																																	// относящейся к Nccoin. За дополнительной
																																	// информацией обращайтесь в Центр Поддержки.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_ABUSING_A_FREE_NCCOIN_FOR_MORE_INFORMATION_PLEASE_VISIT_THE = 2116; // Ваша учетная запись бесплатно jigeupdoen монета
																																	// будет ограничено, и использоваться для определения
																																	// akyonghan истории. Для получения дополнительной
																																	// информации, клиентов центра (тел. 1600-0020) на
																																	// основе запроса, пожалуйста
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_USING_ANOTHER_PERSON_S_IDENTIFICATION_IF_YOU_WERE_NOT = 2117; // Ваша учетная запись заблокирована из-за кражи оплаты
																																// услуг не ограничивается государством. Для получения
																																// дополнительной информации, PlayNC сайте
																																// (www.plaync.co.kr) через клиент-центр расследование,
																																// пожалуйста.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_MISAPPROPRIATING_PAYMENT_UNDER_ANOTHER_PLAYER_S_ACCOUNT_FOR = 2118; // Ваш аккаунт заблокирован за присвоение платежей
																																	// другого аккаунта. За дополнительной информацией
																																	// обращайтесь в Службу Поддержки Пользователей.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FROM_ALL_GAME_SERVICES_AFTER_BEING_DETECTED_WITH_DEALING_AN = 2119; // Ваш аккаунт отключен от всех игровых услуг за торговлю
																																// аккаунтами. \\n За дополнительной информацией
																																// обращайтесь в Службу Поддержки Пользователей.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_10_DAYS_FOR_USING_ILLEGAL_SOFTWARE_YOUR_ACCOUNT_MAY_BE = 2120; // Ваш аккаунт заблокирован на 10 дней за использование
																																// нелегального программного обеспечения. Он может быть
																																// заблокирован бессрочно, если данное нарушение будет
																																// выявлено повторно. За дополнительной информацией
																																// обратитесь в центр поддержки.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FROM_ALL_GAME_SERVICES_FOR_USE_OF_ILLEGAL_SOFTWARE_FOR_MORE = 2121; // Ваш аккаунт отключен от всех игровых услуг за
																																// использование нелегального программного обеспечения.
																																// \\n За дополнительной информацией обращайтесь в Службу
																																// Поддержки Пользователей.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FROM_ALL_GAME_SERVICES_FOR_USE_OF_ILLEGAL_SOFTWARE_FOR_MORE_ = 2122; // Ваш аккаунт отключен от всех игровых услуг за
																																	// использование нелегального программного
																																	// обеспечения. \\n За дополнительной информацией
																																	// обращайтесь в Службу Поддержки Пользователей.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_AT_YOUR_OWN_REQUEST_FOR_MORE_INFORMATION_PLEASE_VISIT_THE = 2123; // Ваш аккаунт заблокирован по Вашему требованию. За
																																// дополнительной информацией обратитесь в Службу
																																// Поддержки Пользователей.
	public static final int THE_SERVER_HAS_BEEN_INTEGRATED_AND_YOUR_CLAN_NAME_S1_HAS_BEEN_OVERLAPPED_WITH_ANOTHER_NAME = 2124; // Сервер был объединен, и имя вашего клана, $s1, было
																																// занято другим кланом. Пожалуйста, введите новое имя
																																// клана.
	public static final int THE_NAME_ALREADY_EXISTS_OR_IS_AN_INVALID_NAME_PLEASE_ENTER_THE_CLAN_NAME_TO_BE_CHANGED = 2125; // Имя уже существует либо оно некорректно. Пожалуйста,
																															// введите другое имя.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FOR_REGULARLY_POSTING_ILLEGAL_MESSAGES_FOR_MORE_INFORMATION = 2126; // Ваш аккаунт был заблокирован за систематические
																																// нелегальные сообщения. За дополнительной информацией
																																// обратитесь в Центр Поддержки.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_AFTER_BEING_DETECTED_WITH_AN_ILLEGAL_MESSAGE_FOR_MORE = 2127; // Ваш аккаунт был заблокирован после обнаружения нелегального
																															// сообщения. За дополнительной информацией обращайтесь в
																															// Центр Поддержки.
	public static final int YOUR_ACCOUNT_HAS_BEEN_SUSPENDED_FROM_ALL_GAME_SERVICES_FOR_USING_THE_GAME_FOR_COMMERCIAL = 2128; // Ваш аккаунт был отключен от всех игровых услуг за
																																// использование игры в коммерческих целях. За
																																// дополнительной информацией обратитесь в центр
																																// поддержки.
	public static final int THE_AUGMENTED_ITEM_CANNOT_BE_CONVERTED_PLEASE_CONVERT_AFTER_THE_AUGMENTATION_HAS_BEEN_REMOVED = 2129; // Улучшенный предмет не может быть преобразован.
																																	// Пожалуйста, преобразуйте после того, как улучшение
																																	// будет снято.
	public static final int YOU_CANNOT_CONVERT_THIS_ITEM = 2130; // Вы не можете преобразовать этот предмет.
	public static final int YOU_HAVE_BID_THE_HIGHEST_PRICE_AND_HAVE_WON_THE_ITEM_THE_ITEM_CAN_BE_FOUND_IN_YOUR_PERSONAL = 2131; // Вы предложили самую высокую ставку и купили предмет.
																																// Он находится в вашей личной мастерской.
	...
	public static final int THE_ASSIGNED_SHORTCUT_WILL_BE_DELETED_AND_THE_INITIAL_SHORTCUT_SETTING_RESTORED_WILL_YOU = 2152; // Назначенные установки ярлыков будут удалены, а исходные
																																// восстановлены. Продолжить?
	public static final int YOU_ARE_CURRENTLY_LOGGED_INTO_10_OF_YOUR_ACCOUNTS_AND_CAN_NO_LONGER_ACCESS_YOUR_OTHER_ACCOUNTS = 2153; // Вы уже зарегистрировали 10 аккаунтов и больше не
																																	// можете регистрировать аккаунты.
	...
	public static final int FORCE_ATTACK_IS_IMPOSSIBLE_AGAINST_A_TEMPORARY_ALLIED_MEMBER_DURING_A_SIEGE = 2158; // Силовая атака невозможна против временных союзников осаждающей
																												// стороны.
	...
	public static final int A_MALICIOUS_SKILL_CANNOT_BE_USED_WHEN_AN_OPPONENT_IS_IN_THE_PEACE_ZONE = 2170; // Вредоносное умение не может быть использовано, когда противник находится в
																											// мирной зоне.
	...
	public static final int ANOTHER_ENCHANTMENT_IS_IN_PROGRESS_PLEASE_COMPLETE_PREVIOUS_TASK_AND_TRY_AGAIN = 2188; // Другое улучшение в процессе. Пожалуйста, завершите текущую задачу и
																													// попробуйте снова.
	public static final int TO_APPLY_SELECTED_OPTIONS_THE_GAME_NEEDS_TO_BE_RELOADED_IF_YOU_DON_T_APPLY_NOW_IT_WILL_BE = 2191; // Для применения выбранных настроек игра должна быть
																																// перезагружена. Если не применить сейчас, то настройки
																																// применятся при следующем входе в игру. Применить
																																// сейчас?
	...
	public static final int THIS_INSTANCE_ZONE_WILL_BE_TERMINATED_BECAUSE_THE_NPC_SERVER_IS_UNAVAILABLE_YOU_WILL_BE_FORCIBLY = 2200; // Эта временная зона закрыта, потому что сервер NPC
																																		// не работает. Сейчас вы будете принудительно
																																		// выброшены из подземелья.
	...
	public static final int YOU_HAVE_ENTERED_AN_AREA_WHERE_THE_MINI_MAP_CANNOT_BE_USED_THE_MINI_MAP_WILL_BE_CLOSED = 2205; // Вы вошли в зону, где миникарта не может быть использована.
																															// Миникарта будет закрыта.
	...
	public static final int YOU_MUST_LEARN_A_GOOD_DEED_SKILL_BEFORE_YOU_CAN_ACQUIRE_NEW_SKILLS = 2211; // Вы должны выучить благотворное умение, прежде чем станут доступны другие
																										// умения.
	...
	public static final int THE_BALLISTA_HAS_BEEN_SUCCESSFULLY_DESTROYED_AND_THE_CLAN_S_REPUTATION_WILL_BE_INCREASED = 2217; // Баллиста была успешно уничтожена. Клановая репутация
																																// возросла.
	...
	public static final int THERE_ARE_NO_OTHER_SKILLS_TO_LEARN_PLEASE_COME_BACK_AFTER_S1ND_CLASS_CHANGE = 2225; // Нет других умений для изучения. Возвращайтесь после $s1-й смены
																												// класса.
	public static final int IT_IS_NOT_POSSIBLE_TO_REGISTER_FOR_THE_CASTLE_SIEGE_SIDE_OR_CASTLE_SIEGE_OF_A_HIGHER_CASTLE_IN = 2227; // Невозможно зарегистрироваться на осаду замка и
																																	// осаду высшего замка в контракте.
	public static final int THE_SUPPLY_ITEMS_HAVE_NOT_NOT_BEEN_PROVIDED_BECAUSE_THE_HIGHER_CASTLE_IN_CONTRACT_DOESN_T_HAVE = 2231; // Предметы поддержки не допускаются, потому что у
																																	// высшего замка в контракте недостаточно очков
																																	// репутации.
	...
	public static final int YOU_CANNOT_REGISTER_FOR_THE_TEAM_BATTLE_CLAN_HALL_WAR_WHEN_YOUR_CLAN_LORD_IS_ON_THE_WAITING_LIST = 2240; // Вы не можете зарегистрироваться на командную
																																		// битву за холл клана, когда глава вашего клана
																																		// находится в листе ожидания на транзакцию.
	public static final int YOU_CANNOT_APPLY_FOR_A_CLAN_LORD_TRANSACTION_IF_YOUR_CLAN_HAS_REGISTERED_FOR_THE_TEAM_BATTLE = 2241; // Если ваш клан зарегистрирован на командную битву за
																																	// холл клана, то транзакция главы клана недоступна.
	public static final int CLAN_MEMBERS_CANNOT_LEAVE_OR_BE_EXPELLED_WHEN_THEY_ARE_REGISTERED_FOR_THE_TEAM_BATTLE_CLAN_HALL = 2242; // Член клана не может покинуть клан, если клан
																																	// заявлен на командную битву за холл клана.
	public static final int WHEN_A_CLAN_LORD_OCCUPYING_THE_BANDIT_STRONGHOLD_OR_WILD_BEAST_RESERVE_CLAN_HALL_IS_IN_DANGER = 2243; // Когда глава клана оккупирует Твердыню Разбойников
																																	// или холл клана в Загоне Диких Зверей в опасности,
																																	// предыдущий глава клана принимает участие в битве
																																	// за холл клана.
	...
	public static final int THE_KEY_YOU_ASSIGNED_AS_A_SHORTCUT_KEY_IS_NOT_AVAILABLE_IN_THE_REGULAR_CHATTING_MODE = 2272; // Клавиша, назначенная вами как ярлык, недоступна в обычном
																															// режиме чата.
	public static final int THIS_SKILL_CANNOT_BE_LEARNED_WHILE_IN_THE_SUB_CLASS_STATE_PLEASE_TRY_AGAIN_AFTER_CHANGING_TO_THE = 2273; // Это умение нельзя выучить подклассом. Вернитесь к
																																		// основному классу и повторите попытку.
	...
	public static final int YOU_HAVE_OBTAINED_ALL_THE_POINTS_YOU_CAN_GET_TODAY_IN_A_PLACE_OTHER_THAN_INTERNET_CAF = 2284; // Сегодня вы добыли все возможные очки в месте, отличном от
																															// интернет кафе.
	...
	public static final int THE_MATCH_BETWEEN_THE_PARTIES_IS_NOT_AVAILABLE_BECAUSE_ONE_OF_THE_PARTY_MEMBERS_IS_BEING = 2289; // Групповое соревнование невозможно, так как один из членов
																																// группы телепортирован.
	...
	public static final int THE_WIDTH_OF_THE_UPLOADED_BADGE_OR_INSIGNIA_DOES_NOT_MEET_THE_STANDARD_REQUIREMENTS = 2294; // Ширина загруженного значка или эмблемы не соответствует
																														// стандартам.
	public static final int THE_LENGTH_OF_THE_UPLOADED_BADGE_OR_INSIGNIA_DOES_NOT_MEET_THE_STANDARD_REQUIREMENTS = 2295; // Длина загруженного значка или эмблемы не соответствует
																															// стандартам.
	public static final int ROUND_S1 = 2297; // Раунд $s1
	public static final int THE_COLOR_OF_THE_BADGE_OR_INSIGNIA_THAT_YOU_WANT_TO_REGISTER_DOES_NOT_MEET_THE_STANDARD = 2298; // Цвет значка или эмблемы, которую Вы хотите
																															// зарегистрировать, не соответствует стандартам.
	public static final int THE_FILE_FORMAT_OF_THE_BADGE_OR_INSIGNIA_THAT_YOU_WANT_TO_REGISTER_DOES_NOT_MEET_THE_STANDARD = 2299; // Формат файла значка или эмблемы, которую вы хотите
																																	// зарегистрировать, не соответствует требованиям.
	public static final int FAILED_TO_LOAD_KEYBOARD_SECURITY_MODULE_FOR_EFFECTIVE_GAMING_FUNCTIONALITY_WHEN_THE_GAME_IS_OVER = 2300; // Невозможно загрузить модуль защиты клавиатуры.
																																		// Когда вы закончите игру, пожалуйста, проверьте
																																		// все файлы в режиме автоматического обновления
																																		// Lineage II.
	public static final int CURRENT_LOCATION__STEEL_CITADEL_RESISTANCE = 2301; // Текущая локация: внутри Стальной Цитадели.
	public static final int YOUR_VITAMIN_ITEM_HAS_ARRIVED_VISIT_THE_VITAMIN_MANAGER_IN_ANY_VILLAGE_TO_OBTAIN_IT = 2302; // Витамин доставлен. Чтобы получить его, найдите менеджера
																														// витаминов в деревне.
	public static final int RESURRECTION_IS_POSSIBLE_BECAUSE_OF_THE_COURAGE_CHARM_S_EFFECT_WOULD_YOU_LIKE_TO_RESURRECT_NOW = 2306; // Воскрешение возможно благодаря эффекту Отвага.
																																	// Хотите воскреснуть?
	...
	public static final int CURRENT_LOCATION_INSIDE_KAMALOKA = 2321; // Текущая локация: внутри Камалоки
	public static final int CURRENT_LOCATION_INSIDE_NIA_KAMALOKA = 2322; // Текущая локация: внутри Земель Камалоки
	public static final int CURRENT_LOCATION_INSIDE_RIM_KAMALOKA = 2323; // Текущая локация: внутри Окрестностей Камалоки
	...
	public static final int ANOTHER_TELEPORT_IS_TAKING_PLACE_PLEASE_TRY_AGAIN_ONCE_THE_TELEPORT_IN_PROCESS_ENDS = 2325; // Происходит телепортация. Повторите попытку, когда процесс
																														// телепортации завершится.
	public static final int CLANS_OF_LEVEL_4_OR_ABOVE_CAN_REGISTER_FOR_HIDEAWAY_WARS_FOR_DEVASTATED_CASTLE_AND_FORTRESS_OF = 2328; // Кланы 4 уровня и выше могут участвовать в битве
																																	// укреплений в Разоренном Замке и Крепости
																																	// Неупокоенных.
	...
	public static final int YOU_CANNOT_RECEIVE_THE_VITAMIN_ITEM_BECAUSE_YOU_HAVE_EXCEED_YOUR_INVENTORY_WEIGHT_QUANTITY_LIMIT = 2333; // Награда не может быть получена, так как в
																																		// инвентаре нет свободного места.
	public static final int SCORE_THAT_SHOWS_A_PLAYER_S_INDIVIDUAL_FAME_FAME_CAN_BE_OBTAINED_BY_PARTICIPATING_IN_A_TERRITORY = 2334; // Очки, показывающие личную репутацию. Могут быть
																																		// добыты в осаде территории, замка, крепости,
																																		// укрепления, в Подземном Колизее, на Фестивале
																																		// Тьмы и Олимпиаде.
	...
	public static final int YOUR_ACCOUNT_IS_TEMPORARILY_LIMITED_BECAUSE_YOUR_GAME_USE_GOAL_IS_PRESUMED_TO_BE_EMBEZZLEMENT_OF = 2346; // Выявлена попытка использования аккаунта с целью
																																		// торговли игровыми предметами за реальные
																																		// деньги. Для более подробной информации
																																		// обратитесь в службу поддержки на сайте игры.
	...
	public static final int YOU_CANNOT_USE_MY_TELEPORTS_WHILE_PARTICIPATING_A_LARGE_SCALE_BATTLE_SUCH_AS_A_CASTLE_SIEGE = 2349; // Во время полномасштабных сражений - осад крепостей,
																																// замков, холлов клана - установить флаг для
																																// последующего возврата к нему невозможно.
	...
	public static final int YOUR_ACCOUNT_HAS_BEEN_CONFIRMED_AS_USING_ANOTHER_PERSON_S_NAME_ALL_GAME_SERVICES_HAVE_BEEN = 2363; // Ваш аккаунт заблокирован, так как он зарегистрирован
																																// под другим именем. За дополнительной информацией
	...
	public static final int YOU_CANNOT_REPORT_A_CHARACTER_WHO_IS_IN_A_PEACE_ZONE_OR_A_BATTLEFIELD = 2377; // Нельзя подать жалобу на персонажа, находящегося в мирной зоне или на поле
																											// боя.
	...
	public static final int YOU_CANNOT_REPORT_A_CHARACTER_WHO_HAS_NOT_ACQUIRED_ANY_EXP_AFTER_CONNECTING = 2379; // Нельзя подавать жалобу на персонажа, который еще не получил опыт после
																												// захода в игру.
	...
	public static final int THIS_ITEM_DOES_NOT_MEET_THE_REQUIREMENTS_FOR_THE_SUPPORT_ENHANCEMENT_SPELLBOOK = 2386; // Этот предмет не подходит по правилам Свитка Дополнительного
																													// Зачарования.
	...
	public static final int THE_MAXIMUM_ACCUMULATION_ALLOWED_OF_PC_CAFE_POINTS_HAS_BEEN_EXCEEDED_YOU_CAN_NO_LONGER_ACQUIRE = 2389; // Количество очков Интернет-кафе превысило лимит.
																																	// Больше невозможно получить очки.
	...
	public static final int C1_HAS_ISSUED_A_PARTY_INVITATION_WHICH_YOU_AUTOMATICALLY_REJECTED_TO_RECEIVE_PARTY_INVITATIONS = 2411; // Вы получили приглашение в ступить в группу от $c1,
																																	// но у Вас установлена блокировка получения
																																	// приглашений в группу. Чтобы получить приглашение,
																																	// измените настройки.
	public static final int THE_BIRTHDAY_GIFT_HAS_BEEN_DELIVERED_VISIT_THE_VITAMIN_MANAGER_IN_ANY_VILLAGE_TO_OBTAIN_IT = 2412; // Вы получили подарок на День Рождения. Получить его
																																// можно у менеджера витаминов.
	public static final int YOU_ARE_REGISTERING_AS_A_RESERVE_ON_THE_AERIAL_CLEFT_RED_TEAM_S_BATTLEFIELD_DO_YOU_WISH_TO = 2413; // Регистрация на битву за Ущелье на стороне красной
																																// команды. Продолжить?
	public static final int YOU_ARE_REGISTERING_AS_A_RESERVE_ON_THE_AERIAL_CLEFT_BLUE_TEAM_S_BATTLEFIELD_DO_YOU_WISH_TO = 2414; // Регистрация на битву за Ущелье на стороне синей
																																// команды. Продолжить?
	public static final int YOU_HAVE_REGISTERED_AS_A_RESERVE_ON_THE_AERIAL_CLEFT_RED_TEAM_S_BATTLEFIELD_WHEN_IN_BATTLE_THE = 2415; // Вы вступили в красную команду. В течение битвы
																																	// команда может быть изменена для поддержания
																																	// баланса игры.
	public static final int YOU_HAVE_REGISTERED_AS_A_RESERVE_ON_THE_AERIAL_CLEFT_BLUE_TEAM_S_BATTLEFIELD_WHEN_IN_BATTLE_THE = 2416; // Вы вступили в синюю команду. В течение битвы
																																	// команда может быть изменена для поддержания
																																	// баланса игры.
	...
	public static final int THE_AERIAL_CLEFT_BATTLEFIELD_HAS_BEEN_ACTIVATED_FLIGHT_TRANSFORMATION_WILL_BE_POSSIBLE_IN = 2419; // Активировано поле битвы за Ущелье. Через 40 сек. станет
																																// возможным перевоплощение в летающее существо.
	...
	public static final int C1_IS_ALREADY_REGISTERED_ON_THE_WAITING_LIST_FOR_THE_NON_CLASS_LIMITED_MATCH_EVENT = 2440; // $c1 находится в списке ожидающих на участие в игре без
	...
	public static final int THE_REQUEST_CANNOT_BE_MADE_BECAUSE_THE_REQUIREMENTS_HAVE_NOT_BEEN_MET_TO_PARTICIPATE_IN_A_TEAM = 2442; // Вы не подходите под условия соревнований. Для
																																	// участия в соревнованиях в группе должно состоять 3
																																	// человека.
	...
	public static final int THE_INVENTORY_IS_FULL_SO_IT_CANNOT_BE_EQUIPPED_OR_REMOVED_ON_THE_BELT = 2452; // Дополнительные ячейки инвентаря переполнены, поэтому снять/надеть пояс
																											// невозможно.
	...
	public static final int IN_ORDER_TO_ACQUIRE_AN_AIRSHIP_THE_CLAN_S_LEVEL_MUST_BE_LEVEL_5_OR_HIGHER = 2456; // Для того чтобы получить Летающий Корабль, клан должен быть выше 5-го
																												// уровня.
	public static final int AN_AIRSHIP_CANNOT_BE_SUMMONED_BECAUSE_EITHER_YOU_HAVE_NOT_REGISTERED_YOUR_AIRSHIP_LICENSE_OR_THE = 2457; // Вы не ввели разрешение на вызов Летающего
																																		// Корабля, или Ваш клан не обладает им.
	...
	public static final int THE_AIRSHIP_S_FUEL_EP_HAS_RUN_OUT_THE_AIRSHIP_S_SPEED_WILL_BE_GREATLY_DECREASED_IN_THIS = 2464; // Закончилось Топливо Летающего Корабля (EP). Скорость
																															// корабля будет минимальной.
	public static final int YOU_HAVE_SELECTED_A_NON_CLASS_LIMITED_TEAM_MATCH_DO_YOU_WISH_TO_PARTICIPATE = 2465; // Вы выбрали игру без ограничения по классам. Вы правда хотите принять в
																												// ней участие?
	...
	public static final int YOU_HAVE_USED_A_REPORT_POINT_ON_C1_YOU_HAVE_S2_POINTS_REMAINING_ON_THIS_ACCOUNT = 2468; // Вы использовали очки для того, чтобы сообщить о $c1. У Вас
																													// осталось $s2 очков.
	...
	public static final int THIS_CHARACTER_CANNOT_MAKE_A_REPORT_YOU_CANNOT_MAKE_A_REPORT_WHILE_LOCATED_INSIDE_A_PEACE_ZONE = 2470; // Сообщить о данном персонаже нельзя. Он находится в
																																	// Мирной Зоне, на Поле Боя или участвует в Войне
																																	// Кланов или Олимпиаде.
	public static final int THIS_CHARACTER_CANNOT_MAKE_A_REPORT_THE_TARGET_HAS_ALREADY_BEEN_REPORTED_BY_EITHER_YOUR_CLAN_OR = 2471; // Сообщить о данном персонаже нельзя. О данном
																																	// персонаже уже сообщил член Вашего клана, альянса,
																																	// или сообщение было подано с Вашего IP.
	public static final int THIS_CHARACTER_CANNOT_MAKE_A_REPORT_BECAUSE_ANOTHER_CHARACTER_FROM_THIS_ACCOUNT_HAS_ALREADY_DONE = 2472; // Сообщить о данном персонаже нельзя. Уже получено
																																		// сообщение о нем с другого персонажа Вашего
																																		// аккаунта.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_CHATTING_WILL_BE_BLOCKED_FOR_10 = 2473; // Получено сообщение о том, что Вы используете
																																// нелегальную программу. Вы не сможете использовать чат
																																// в течение 10-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_PARTY_PARTICIPATION_WILL_BE_BLOCKED_60 = 2474; // Получено сообщение о том, что Вы используете
																																		// нелегальную программу. Вы не сможете вступить
																																		// в группу в течение 60-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_PARTY_PARTICIPATION_WILL_BE_BLOCKED_120 = 2475; // Получено сообщение о том, что Вы используете
																																		// нелегальную программу. Вы не сможете вступить
																																		// в группу в течение 120-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_PARTY_PARTICIPATION_WILL_BE_BLOCKED_180 = 2476; // Получено сообщение о том, что Вы используете
																																		// нелегальную программу. Вы не сможете вступить
																																		// в группу в течение 180-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_ACTIONS_WILL_BE_RESTRICTED_FOR_120 = 2477; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу. Вы будете ограничены в
																																	// движениях в течение 120-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_ACTIONS_WILL_BE_RESTRICTED_FOR_180 = 2478; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу. Вы будете ограничены в
																																	// движениях в течение 180-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_ACTIONS_WILL_BE_RESTRICTED_FOR_180_1 = 2479; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу. Вы будете ограничены в
																																	// движениях в течение 180-ти мин.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_MOVING_WILL_BE_BLOCKED_FOR_120_MINUTES = 2480; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу. Вы будете не сможете
																																	// перемещаться в течение 120-ти мин.
	public static final int C1_HAS_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_HAS_BEEN_INVESTIGATED = 2481; // Персонаж $c1 сообщил о том, что Вы используете нелегальную программу,
																												// поэтому Вы не сможете получить награду.
	public static final int C1_HAS_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_CANNOT_JOIN_A_PARTY = 2482; // Персонаж $c1 сообщил о том, что Вы используете нелегальную программу,
																											// поэтому Вы не можете вступить в группу.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_CHATTING_IS_NOT_ALLOWED = 2483; // Получено сообщение о том, что Вы используете нелегальную программу,
																													// поэтому чат запрещен.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_PARTICIPATING_IN_A_PARTY_IS_NOT_ALLOWED = 2484; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу, поэтому Вы не сможете
																																	// вступить в группу.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_ACTIVITIES_ARE_ONLY_ALLOWED_WITHIN = 2485; // Получено сообщение о том, что Вы используете
																																	// нелегальную программу, поэтому Вы будете
																																	// ограничены в движениях.
	public static final int YOU_HAVE_BEEN_BLOCKED_DUE_TO_VERIFICATION_THAT_YOU_ARE_USING_A_THIRD_PARTY_PROGRAM_SUBSEQUENT = 2486; // До сих пор Вы получали штрафы за использование
																																	// нелегальных программ в соответствии с количеством
																																	// имеющихся у Вас очков. Со следующего раза штраф
																																	// будет предусматривать не только игровые штрафы, но
																																	// и неудобства в использовании аккаунта.
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_CONNECTION_HAS_BEEN_ENDED_PLEASE = 2487; // Получено сообщение о том, что Вы используете
																																// нелегальную программу, поэтому игра завершена. Вы
																																// сможете снова войти в игру после идентификации
																																// личности.
	public static final int YOU_CANNOT_ENTER_AERIAL_CLEFT_BECAUSE_YOU_ARE_NOT_AT_THE_RIGHT_LEVEL_ENTRY_IS_POSSIBLE_ONLY = 2488; // Ваш уровень не соответствует требованиям. Чтобы
																																// попасть в Ущелье, необходимо достичь 75-го уровня.
	public static final int YOU_MUST_TARGET_A_CONTROL_DEVICE_IN_ORDER_TO_PERFORM_THIS_ACTION = 2489; // Вы не выбрали в качестве цели существо, которым можно управлять, поэтому данная
																										// функция недоступна.
	public static final int YOU_CANNOT_PERFORM_THIS_ACTION_BECAUSE_YOU_ARE_TOO_FAR_AWAY_FROM_THE_CONTROL_DEVICE = 2490; // Вы находитесь слишком далеко от существа, поэтому контроль над
																														// ним невозможен.
	...
	public static final int ENTER_CHAT_MODE_IS_AUTOMATICALLY_ENABLED_WHEN_YOU_ARE_IN_A_FLYING_TRANSFORMATION_STATE = 2493; // Перевоплотившись в летающее существо, Вы входите в режим
																															// внутреннего чата.
	public static final int ENTER_CHAT_MODE_IS_AUTOMATICALLY_ENABLED_WHEN_YOU_ARE_IN_AIRSHIP_CONTROL_STATE = 2494; // Начав управление Летающим Кораблем, Вы входите в режим внутреннего
																													// чата.
	public static final int W_GO_FORWARD_S_STOP_A_TURN_LEFT_D_TURN_RIGHT_E_INCREASE_ALTITUDE_AND_Q_DECREASE_ALTITUDE = 2495; // W(Вперед), S(Остановиться), A(Влево), D(Вправо),
																																// E(Набрать Высоту), Q(Снизиться).
	public static final int IF_YOU_CLICK_ON_A_SKILL_DESIGNATED_ON_YOUR_SHORTCUT_BAR_THAT_SLOT_IS_ACTIVATED_ONCE_ACTIVATED = 2496; // Нажав клавишу, соответствующую ярлыку, Вы
																																	// активируете панель ярлыков, а повторно нажав на
																																	// нее или на пробел, Вы активируете ярлык.
	public static final int TO_CLOSE_THE_CURRENTLY_OPEN_TIP_PLEASE_CANCEL_THE_CHECKED_BOX__SYSTEM_TUTORIAL__IN_OPTIONS = 2497; // Чтобы отключить подсказки, выключите отметку "Системное
																																// Обучение" в настройках игры.
	public static final int DURING_THE_AIRSHIP_CONTROL_STATE_YOU_CAN_ALSO_CHANGE_ALTITUDE_USING_THE_BUTTON_AT_THE_CENTER_OF = 2498; // Изменить высоту Летающего Корабля можно также с
																																	// помощью иконок панели управления.
	...
	public static final int THE_BUFF_IN_THE_PARTY_WINDOW_IS_TOGGLED_BUFF_FOR_ONE_INPUT_DEBUFF_FOR_TWO_INPUTS_A_SONG_AND = 2510; // Положительный эффект в окне группы включен.
																																// Положительный эффект для одного ввода, отрицательный
																																// эффект для двух, танец и пение для трех и выключение
																																// для четырех.
	...
	public static final int ASSIGN_1ST_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2513; // Назначьте ярлык к 1-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_2ND_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2514; // Назначьте ярлык к 2-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_3RD_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2515; // Назначьте ярлык к 3-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_4TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2516; // Назначьте ярлык к 4-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_5TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2517; // Назначьте ярлык к 5-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_6TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2518; // Назначьте ярлык к 6-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_7TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2519; // Назначьте ярлык к 7-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_8TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2520; // Назначьте ярлык к 8-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_9TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2521; // Назначьте ярлык к 9-му слоту в окне базовых ярлыков.
																																	// Комбинация Ctrl+Shift не может быть назначена.
	public static final int ASSIGN_10TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2522; // Назначьте ярлык к 10-му слоту в окне базовых
																																	// ярлыков. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int ASSIGN_11TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2523; // Назначьте ярлык к 11-му слоту в окне базовых
																																	// ярлыков. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int ASSIGN_12TH_SLOT_SHORTCUT_IN_THE_SHORTCUT_BASE_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT_CANNOT_BE = 2524; // Назначьте ярлык к 12-му слоту в окне базовых
																																	// ярлыков. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int ASSIGN_1ST_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2525; // Назначьте ярлык к 1-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_2ND_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2526; // Назначьте ярлык к 2-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_3RD_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2527; // Назначьте ярлык к 3-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_4TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2528; // Назначьте ярлык к 4-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_5TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2529; // Назначьте ярлык к 5-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_6TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2530; // Назначьте ярлык к 6-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_7TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2531; // Назначьте ярлык к 7-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_8TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2532; // Назначьте ярлык к 8-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_9TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2533; // Назначьте ярлык к 9-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_10TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2534; // Назначьте ярлык к 10-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_11TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2535; // Назначьте ярлык к 11-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_12TH_SLOT_SHORTCUT_IN_THE_1ST_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2536; // Назначьте ярлык к 12-му слоту в 1-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_1ST_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2537; // Назначьте ярлык к 1-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_2ND_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2538; // Назначьте ярлык к 2-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_3RD_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2539; // Назначьте ярлык к 3-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_4TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2540; // Назначьте ярлык к 4-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_5TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2541; // Назначьте ярлык к 5-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_6TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2542; // Назначьте ярлык к 6-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_7TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2543; // Назначьте ярлык к 7-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_8TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2544; // Назначьте ярлык к 8-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_9TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2545; // Назначьте ярлык к 9-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_10TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2546; // Назначьте ярлык к 10-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_11TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2547; // Назначьте ярлык к 11-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	public static final int ASSIGN_12TH_SLOT_SHORTCUT_IN_THE_2ND_SHORTCUT_EXPANDED_WINDOW_COMBINATION_OF_CTRL_AND_SHIFT = 2548; // Назначьте ярлык к 12-му слоту в 2-м окне расширенных
																																// ярлыков. Комбинация Ctrl+Shift не может быть
																																// назначена.
	...
	public static final int OPENS_AND_CLOSES_THE_ACTION_WINDOW_EXECUTING_CHARACTER_ACTIONS_AND_GAME_COMMANDS = 2559; // Открывает и закрывает окно действий, исполняющее действия
																														// персонажа и игровые команды.
	...
	public static final int OPENS_AND_CLOSES_THE_CLAN_WINDOW_CONFIRMING_INFORMATION_OF_THE_INCLUDED_CLAN_AND_PERFORMS_THE = 2563; // Открывает и закрывает окно клана, предоставляющее
																																	// информацию о клане и разнообразные установки
																																	// касательно клана.
	public static final int OPENS_AND_CLOSES_THE_STATUS_WINDOW_SHOWING_THE_DETAILED_STATUS_OF_A_CHARACTER_THAT_YOU_CREATED = 2564; // Открывает и закрывает окно статуса, показывающее
																																	// детали состояния персонажа.
	...
	public static final int OPENS_AND_CLOSES_THE_SKILL_WINDOW_DISPLAYING_THE_LIST_OF_SKILLS_THAT_YOU_CAN_USE = 2568; // Открывает и закрывает окно умений, отображающее перечень
																														// доступных к использованию умений.
	...
	public static final int OPENS_AND_CLOSES_THE_MINI_MAP_SHOWING_DETAILED_INFORMATION_ABOUT_THE_GAME_WORLD = 2570; // Открывает и закрывает миникарту, показывающую детализированную
																													// информацию об игровом мире.
	public static final int OPENS_AND_CLOSES_THE_OPTION_WINDOW = 2571; // Открывает и закрывает окно опций.
	public static final int OPEN_AND_CLOSE_THE_PARTY_MATCHING_WINDOW_USEFUL_IN_ORGANIZING_A_PARTY_BY_HELPING_TO_EASILY_FIND = 2572; // Открывает и закрывает окно подбора группы,
																																	// помогающее найти других персонажей, желающих
																																	// сформировать группу.
	public static final int OPEN_AND_CLOSE_THE_QUEST_JOURNAL_DISPLAYING_THE_PROGRESS_OF_QUESTS = 2573; // Открывает и закрывает журнал квестов, отображающий прогресс в прохождении
																										// квестов.
	...
	public static final int OPENS_AND_CLOSES_THE_SYSTEM_MENU_WINDOW_ENABLES_DETAILED_MENU_SELECTION = 2576; // Открывает и закрывает окно системных опций, разрешающее детальные
																											// настройки меню.
	public static final int DO_NOT_SHOW_DROP_ITEMS_DROPPED_IN_THE_WORLD_GAME_PERFORMANCE_SPEED_CAN_BE_ENHANCED_BY_USING_THIS = 2577; // Не показывать выпавшие предметы. Эта опция может
																																		// улучшить скорость игры.
	...
	public static final int QUICKLY_SWITCH_THE_CONTENT_OF_THE_EXPANDED_SHORTCUT_WINDOW = 2592; // Быстро преобразовывает содержимое раскрытого окна ярлыков. Эта функция сейчас
																								// недоступна.
	...
	public static final int YOU_WERE_EXCLUDED_FROM_THE_MATCH_BECAUSE_THE_REGISTRATION_COUNT_WAS_NOT_CORRECT = 2702; // Количество игроков не соответствовало требованиям, поэтому Вы были
																													// исключены из команды.
	...
	public static final int YOU_CANNOT_MAKE_ANOTHER_REQUEST_FOR_10_SECONDS_AFTER_CANCELLING_A_MATCH_REGISTRATION = 2707; // В течение 10-ти сек. после отмены регистрации в соревнованиях
																															// Вы не сможете повторить попытку.
	...
	public static final int APPLICANTS_FOR_THE_OLYMPIAD_UNDERGROUND_COLISEUM_OR_KRATEI_S_CUBE_MATCHES_CANNOT_REGISTER = 2709; // Подавший заявку на участие в Олимпиаде, Битве за
																																// Подземный Зал Боев или Куб Кратеи не может
																																// зарегистрироваться.
	...
	public static final int THE_SKILL_CANNOT_BE_USED_BECAUSE_THE_TARGET_S_LOCATION_IS_TOO_HIGH_OR_LOW = 2718; // Цель находится слишком высоко или низко, поэтому Вы не можете
																												// воспользоваться этим умением.
	...
	public static final int INSTANT_ZONE_FROM_HERE__S1_S_ENTRY_HAS_BEEN_RESTRICTED_YOU_CAN_CHECK_THE_NEXT_ENTRY_POSSIBLE = 2720; // Вход во временную зону $s1 закрыт. Время следующего
																																	// входа можно проверить с помощью команды
																																	// "/Временная Зона".
	public static final int BOARDING_OR_CANCELLATION_OF_BOARDING_ON_AIRSHIPS_IS_NOT_ALLOWED_IN_THE_CURRENT_AREA = 2721; // В данной локации Вы не можете взойти на Летающий Корабль/сойти
																														// с Летающего Корабля.
	public static final int ANOTHER_AIRSHIP_HAS_ALREADY_BEEN_SUMMONED_AT_THE_WHARF_PLEASE_TRY_AGAIN_LATER = 2722; // В Воздушной Гавани находится другой Летающий Корабль. Повторите
																													// попытку позже.
	...
	public static final int YOU_CANNOT_SUMMON_THE_AIRSHIP_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS = 2725; // Вы не можете вызвать Летающий Корабль, так как не соответствуете
																											// требованиям.
	public static final int YOU_CANNOT_PURCHASE_THE_AIRSHIP_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS = 2726; // Вы не можете купить Летающий Корабль, так как не соответствуете
																												// требованиям.
	...
	public static final int YOU_CAN_CONTROL_THE_AIRSHIP_BY_TARGETING_THE_AIRSHIP_S_CONTROL_KEY_AND_PRESSING_THE__CONTROL_ = 2741; // Управление Летающим Кораблем возможно, если выбрать
																																	// в качестве цели Панель Управления и выбрать
																																	// действие "Управлять"
	...
	public static final int IF_YOU_RESTART_WHILE_ON_AN_AIRSHIP_YOU_WILL_RETURN_TO_THE_DEPARTURE_LOCATION = 2743; // Выполнив перезапуск игры, находясь в Летающем Корабле, Вы окажетесь в
																													// точке отправки Корабля.
	public static final int IF_YOU_PRESS_THE__CONTROL_CANCEL__ACTION_BUTTON_YOU_CAN_EXIT_THE_CONTROL_STATE_AT_ANY_TIME = 2744; // С помощью действия "Выйти" Вы можете отменить
																																// управление кораблем.
	...
	public static final int AIRSHIP_TELEPORT_IS_POSSIBLE_THROUGH_THE__DEPART__ACTION_AND_IN_THAT_CASE_FUEL_EP_IS_CONSUMED = 2747; // С помощью действия "Взлет" Вы можете переместиться,
																																	// будучи в Летающем Корабле, но при этом
																																	// затрачивается топливо(EP).
	public static final int YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_CANNOT_REPORT_OTHER_USERS = 2748; // Получено сообщение о том, что Вы пользуетесь нелегальной
																													// программой, поэтому Вы не можете сообщить о другом игроке.
	...
	public static final int PVP_MATCHES_SUCH_AS_OLYMPIAD_UNDERGROUND_COLISEUM_AERIAL_CLEFT_KRATEI_S_CUBE_AND_HANDY_S_BLOCK = 2754; // Вы не можете участвовать одновременно в нескольких
																																	// PVP соревнованиях (Олимпиада, Подземный Зал Боев,
																																	// Ущелье, Куб Кратеи и Арена).
	...
	public static final int YOU_CANNOT_ENTER_BECAUSE_THE_CORRESPONDING_ALLIANCE_CHANNEL_S_MAXIMUM_NUMBER_OF_ENTRANTS_HAS = 2764; // Количество участников Союзного Канала достигло
																																	// максимума, поэтому вход воспрещен.
	...
	public static final int YOU_CAN_MAKE_ANOTHER_REPORT_IN_S1_MINUTES_YOU_HAVE_S2_POINTS_REMAINING_ON_THIS_ACCOUNT = 2774; // Через $s1 Вы сможете подать петицию. У Вас осталось еще $s2
																															// очков.
	public static final int THE_MATCH_CANNOT_TAKE_PLACE_BECAUSE_A_PARTY_MEMBER_IS_IN_THE_PROCESS_OF_BOARDING = 2775; // Член группы сейчас находится верхом на Питомце и поэтому Дуэль
																														// между Группами невозможна.
	public static final int THE_EFFECT_OF_TERRITORY_WARD_IS_DISAPPEARING = 2776; // Эффект Знамени пропадает.
	public static final int THE_AIRSHIP_SUMMON_LICENSE_HAS_BEEN_ENTERED_YOUR_CLAN_CAN_NOW_SUMMON_THE_AIRSHIP = 2777; // Вы успешно передали разрешение на вызов Летающего Корабля. Теперь
																														// Ваш клан может вызвать Летающий Корабль.
	...
	public static final int THE_BATTLEFIELD_HAS_BEEN_CLOSED_THE_MATCH_HAS_ENDED_IN_A_TIE_BECAUSE_THE_MATCH_LASTED_FOR_S1 = 2784; // Противник покинул Арену. Время битвы составило $s1
																																	// мин. $s2 сек. не достигнув минимальных 15-ти мин.,
																																	// поэтому зачислена ничья.
	public static final int IT_S_A_LARGE_SCALED_AIRSHIP_FOR_TRANSPORTATIONS_AND_BATTLES_AND_CAN_BE_OWNED_BY_THE_UNIT_OF_CLAN = 2785; // Данный Летающий Корабль может принадлежать
																																		// исключительно кланам, он отлично подходят для
																																		// перевозок и битв.
	...
	public static final int THE_MINIMUM_NUMBER_S1_OF_PEOPLE_TO_ENTER_INSTANT_ZONE_IS_NOT_MET_AND_ENTRY_IS_NOT_AVAILABLE = 2793; // Минимальное количество участников, необходимое для
																																// попадания во временную зону($s1 чел.) не достигнуто,
																																// поэтому вход в нее невозможен.
	...
	public static final int THE_CLAN_WHO_OWNS_THE_TERRITORY_CANNOT_PARTICIPATE_IN_THE_TERRITORY_WAR_AS_MERCENARIES = 2796; // Члены Клана, владеющего Землями, не могут принять участие в
																															// Битве за Земли в качестве наемников.
	public static final int IT_IS_NOT_A_TERRITORY_WAR_REGISTRATION_PERIOD_SO_A_REQUEST_CANNOT_BE_MADE_AT_THIS_TIME = 2797; // Период регистрации завершен. Вы не можете подать заявку на
																															// участие в Битве.
	...
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_1 = 2816; // Назначьте ярлык к 1-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_2 = 2817; // Назначьте ярлык к 2-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_3 = 2818; // Назначьте ярлык к 3-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_4 = 2819; // Назначьте ярлык к 4-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_5 = 2820; // Назначьте ярлык к 5-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_6 = 2821; // Назначьте ярлык к 6-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_7 = 2822; // Назначьте ярлык к 7-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_8 = 2823; // Назначьте ярлык к 8-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_9 = 2824; // Назначьте ярлык к 9-му слоту в окне ярлыков
																																	// летающего существа. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_10 = 2825; // Назначьте ярлык к 10-му слоту в окне ярлыков
																																		// летающего существа. Комбинация Ctrl+Shift не
																																		// может быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_11 = 2826; // Назначьте ярлык к 11-му слоту в окне ярлыков
																																		// летающего существа. Комбинация Ctrl+Shift не
																																		// может быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_FLYING_TRANSFORMED_OBJECT_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_12 = 2827; // Назначьте ярлык к 12-му слоту в окне ярлыков
																																		// летающего существа. Комбинация Ctrl+Shift не
																																		// может быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_1_SLOT_THE_CTRL = 2828; // Назначьте ярлык к 1-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_2_SLOT_THE_CTRL = 2829; // Назначьте ярлык к 2-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_3_SLOT_THE_CTRL = 2830; // Назначьте ярлык к 3-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_4_SLOT_THE_CTRL = 2831; // Назначьте ярлык к 4-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_5_SLOT_THE_CTRL = 2832; // Назначьте ярлык к 5-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_6_SLOT_THE_CTRL = 2833; // Назначьте ярлык к 6-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_7_SLOT_THE_CTRL = 2834; // Назначьте ярлык к 7-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_8_SLOT_THE_CTRL = 2835; // Назначьте ярлык к 8-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_9_SLOT_THE_CTRL = 2836; // Назначьте ярлык к 9-му слоту в окне ярлыков ездового
																																	// животного. Комбинация Ctrl+Shift не может быть
																																	// назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_10_SLOT_THE_CTRL = 2837; // Назначьте ярлык к 10-му слоту в окне ярлыков
																																	// ездового животного. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_11_SLOT_THE_CTRL = 2838; // Назначьте ярлык к 11-му слоту в окне ярлыков
																																	// ездового животного. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	public static final int DESIGNATE_A_SHORTCUT_KEY_FOR_THE_MOUNTABLE_EXCLUSIVE_USE_SHORTCUT_WINDOW_S_NO_12_SLOT_THE_CTRL = 2839; // Назначьте ярлык к 12-му слоту в окне ярлыков
																																	// ездового животного. Комбинация Ctrl+Shift не может
																																	// быть назначена.
	...
	public static final int IF_YOU_JOIN_THE_CLAN_ACADEMY_YOU_CAN_BECOME_A_CLAN_MEMBER_AND_LEARN_THE_GAME_SYSTEM_UNTIL_YOU = 2853; // Поступив в академию клана, Вы можете стать членом
																																	// клана и изучать игровую систему до получения 40-го
																																	// уровня. Если хотите получать от игры больше
																																	// удовольствия, то мы рекомендуем Вам поступить в
																																	// академию клана.
	public static final int IF_YOU_BECOME_LEVEL_40_THE_SECOND_CLASS_CHANGE_IS_AVAILABLE_IF_YOU_COMPLETE_THE_SECOND_CLASS = 2854; // По достижении 40-го уровня Вы получаете возможность
																																	// второй смены профессии. После второй смены
																																	// профессии возможности Вашего персонажа возрастут.
	...
	public static final int YOU_CAN_SELECT_SEVERAL_OPTIONS_RELATED_TO_THE_GAME_INCLUDING_GRAPHIC_SETTINGS_AND_SOUND_SETTINGS = 2857; // You can select several options related to the
																																		// game, including graphic settings and sound
																																		// settings.
	...
	public static final int THIS_DISPLAYS_THE_LIST_OF_ALL_THE_QUESTS_THAT_MY_CHARACTER_IS_UNDERTAKING_THE_QUEST_PROGRESS = 2863; // This displays the list of all the quests that my
																																	// character is undertaking. The quest progress
																																	// status can be easily managed.
	public static final int THIS_DISPLAYS_MY_CHARACTER_S_DETAILED_STATUS_INFORMATION_I_CAN_EASILY_CONFIRM_WHEN_AN_ITEM_IS = 2864; // This displays my character's detailed status
																																	// information. I can easily confirm when an item is
																																	// equipped, when a buff is received, and how much
																																	// stronger my character has become.
	public static final int THIS_OPENS_AN_INVENTORY_WINDOW_WHERE_I_CAN_CHECK_THE_LIST_OF_ALL_MY_CHARACTER_S_ITEMS = 2865; // This opens an inventory window where I can check the list of
																															// all my character's items.
	public static final int I_CAN_SEE_INFORMATION_ABOUT_MY_LOCATION_BY_OPENING_A_MINI_MAP_WINDOW_AND_I_CAN_CHECK_CURRENT = 2866; // I can see information about my location by opening a
																																	// mini-map window, and I can check current
																																	// information about the entire game world.
	public static final int CLICK_HERE_TO_SEE_A_GAME_SYSTEM_MENU_THAT_CONTAINS_VARIOUS_FUNCTIONS_OF_THE_GAME_YOU_CAN_CHECK = 2867; // Click here to see a game system menu that contains
																																	// various functions of the game. You can check
																																	// information about the game bulletin, macro, help,
																																	// GM suppression button, game option button, game
																																	// restart button and the game quit button.
	public static final int IF_YOU_CLICK_THE_CHAT_TAB_YOU_CAN_SELECT_AND_VIEW_THE_MESSAGES_OF_YOUR_DESIRED_GROUP_THE_TABS = 2868; // If you click the Chat tab, you can select and view
																																	// the messages of your desired group. The tabs can
																																	// be separated by using drag-and-drop.
	public static final int YOU_CAN_CLOSE_OR_OPEN_SPECIFIC_MESSAGES_FROM_THE_CHAT_SCREEN_YOU_CAN_CLOSE_OR_OPEN_THE_SYSTEM = 2869; // You can close or open specific messages from the
																																	// chat screen. You can close or open the system
																																	// message exclusive window.
	public static final int YOU_CAN_LOGIN_ONTO_MSN_MESSENGER_YOU_CAN_ALSO_CHAT_WITH_REGISTERED_FRIENDS_WITHIN_THE_GAME = 2870; // You can login onto MSN Messenger. You can also chat
																																// with registered friends within the game.
	public static final int YOU_CAN_USE_THE_PARTY_MATCHING_FUNCTION_THAT_ALLOWS_YOU_TO_EASILY_FORM_PARTIES_WITH_OTHER = 2871; // You can use the party matching function that allows you
																																// to easily form parties with other players.
	public static final int YOU_CAN_INSTALL_VARIOUS_RAID_OPTIONS_SUCH_AS_MONSTER_OR_PARTY_MEMBER_MARK_AND_RAID_FIX = 2872; // You can install various raid options such as monster or
																															// party member mark and raid fix.
	...
	public static final int YOU_HAVE_ENTERED_A_POTENTIALLY_HOSTILE_ENVIRONMENT_SO_THE_AIRSHIP_S_SPEED_HAS_BEEN_GREATLY = 2907; // Вы попали в скопление большого количества монстров.
																																// Скорость Летающего Корабля снизится.
	public static final int AS_YOU_ARE_LEAVING_THE_HOSTILE_ENVIRONMENT_THE_AIRSHIP_S_SPEED_HAS_BEEN_RETURNED_TO_NORMAL = 2908; // Вы прошли через скопление большого количества монстров.
																																// Скорость Летающего Корабля восстановлена.
	...
	public static final int THE_TERRITORY_WAR_WILL_BEGIN_IN_20_MINUTES_TERRITORY_RELATED_FUNCTIONS_IE__BATTLEFIELD_CHANNEL = 2914; // До начала Битвы за Земли осталось 20мин!
																																	// Активируется Канал Битвы, появляется возможность
																																	// маскировки и перевоплощения.
	public static final int THIS_CLAN_MEMBER_CANNOT_WITHDRAW_OR_BE_EXPELLED_WHILE_PARTICIPATING_IN_A_TERRITORY_WAR = 2915; // Член клана, участвующий в Битве за Землю, не может покинуть
																															// клан.
	...
	public static final int ONLY_CHARACTERS_WHO_ARE_LEVEL_40_OR_ABOVE_WHO_HAVE_COMPLETED_THEIR_SECOND_CLASS_TRANSFER_CAN = 2918; // В Битве за Земли могут принять участие персонажи,
																																	// достигшие 40-го уровня и сменившие 2-ю профессию.
	...
	public static final int NO_MORE_AIRSHIPS_CAN_BE_SUMMONED_AS_THE_MAXIMUM_AIRSHIP_LIMIT_HAS_BEEN_MET = 2920; // Вы превысили количество вызванных Летающих Кораблей и не можете вызвать
																												// еще один.
	...
	public static final int YOUR_REQUEST_CANNOT_BE_PROCESSED_BECAUSE_THERE_S_NO_ENOUGH_AVAILABLE_MEMORY_ON_YOUR_GRAPHIC_CARD = 2929; // Память видеокарты максимально загружена, поэтому
																																		// запуск невозможен. Смените разрешение и
																																		// повторите попытку.
	public static final int A_GRAPHIC_CARD_INTERNAL_ERROR_HAS_OCCURRED_PLEASE_INSTALL_THE_LATEST_VERSION_OF_THE_GRAPHIC_CARD = 2930; // Произошла внутренняя ошибка видеокарты.
																																		// Попробуйте установить последнюю версию
																																		// драйверов для видеокарты.
	public static final int THE_SYSTEM_FILE_MAY_HAVE_BEEN_DAMAGED_AFTER_ENDING_THE_GAME_PLEASE_CHECK_THE_FILE_USING_THE = 2931; // Есть вероятность, что был поврежден системный файл.
																																// Завершите игу и совершите полную проверку файлов игры.
	...
	public static final int THE_DISGUISE_SCROLL_CANNOT_BE_USED_BECAUSE_IT_IS_MEANT_FOR_USE_IN_A_DIFFERENT_TERRITORY = 2936; // Свиток не подходит к Змелям, в которых Вы состоите,
																															// поэтому невозможно замаскироваться.
	...
	public static final int THE_DISGUISE_SCROLL_CANNOT_BE_USED_WHILE_YOU_ARE_ENGAGED_IN_A_PRIVATE_STORE_OR_MANUFACTURE = 2938; // Невозможно замаскироваться, когда Вы открыли личную
																																// торговую лавку или личную мастерскую
	...
	public static final int YOU_CAN_INCREASE_THE_CHANCE_TO_ENCHANT_THE_ITEM_PRESS_THE_START_BUTTON_BELOW_TO_BEGIN = 2940; // Вы можете использовать предмет, повышающий шанс успешного
																															// зачарования. Зачарование начнется, если нажать на кнопку
																															// 'Начать'.
	public static final int THE_REQUEST_CANNOT_BE_COMPLETED_BECAUSE_THE_REQUIREMENTS_ARE_NOT_MET_IN_ORDER_TO_PARTICIPATE_IN = 2941; // Не выполнены требования, поэтому невозможно подать
																																	// заявку. Чтобы принять участие в командном
																																	// соревновании, необходимо, чтобы у всех членов
																																	// команды очки Олимпиады были выше 1.
	public static final int THE_FIRST_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_HOURS_S2_MINUTES_S3_SECONDS__IF_YOU_RESUMMON_THE = 2942; // До получения первого подарка осталось: $s1 ч. $s2
																																	// мин. $s3 сек. (Если призвать Агатиона еще раз,
																																	// время получения может занять на 10 минут больше.)
	public static final int THE_FIRST_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_MINUTES_S2_SECONDS_IF_YOU_RESUMMON_THE_AGATHION = 2943; // До получения первого подарка осталось: $s1 мин. $s2
																																	// сек. (Если призвать Агатиона еще раз, время
																																	// получения может занять на 10 минут больше.)
	public static final int THE_FIRST_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_SECONDS__IF_YOU_RESUMMON_THE_AGATHION_AT_THE_GIFT = 2944; // До получения первого подарка осталось: $s1 сек.
																																		// (Если призвать Агатиона еще раз, время
																																		// получения может занять на 10 минут больше.)
	public static final int THE_SECOND_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_HOURS_S2_MINUTES_S3_SECONDS__IF_YOU_RESUMMON_THE = 2945; // До получения второго подарка осталось: $s1 ч. $s2
																																		// мин. $s3 сек. (Если призвать Агатиона еще раз,
																																		// время получения может занять на 1 ч. 10 минут
																																		// больше.)
	public static final int THE_SECOND_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_MINUTES_S2_SECONDS_IF_YOU_RESUMMON_THE_AGATHION = 2946; // До получения второго подарка осталось: $s1 мин.
																																	// $s2 сек. (Если призвать Агатиона еще раз, время
																																	// получения может занять на 1 ч. 10 минут больше.)
	public static final int THE_SECOND_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_SECONDS_IF_YOU_RESUMMON_THE_AGATHION_AT_THE_GIFT = 2947; // До получения второго подарка осталось: $s1 сек.
																																		// (Если призвать Агатиона еще раз, время
																																		// получения может занять на 1 ч. 10 минут
																																		// больше.)
	public static final int THE_TERRITORY_WAR_EXCLUSIVE_DISGUISE_AND_TRANSFORMATION_CAN_BE_USED_20_MINUTES_BEFORE_THE_START = 2955; // Маскировка и Перевоплощение, котороые используются
																																	// во время Битвы за Земли, доступны для
																																	// использования за 20 мин. до Битвы и 10 мин. после
																																	// ее окончания.
	...
	public static final int CHARACTERS_WITH_A_FEBRUARY_29_CREATION_DATE_WILL_RECEIVE_A_GIFT_ON_FEBRUARY_28 = 2957; // Персонажи, созданные 29-го февраля, смогут получить подарок 28-го
																													// февраля.
	public static final int AN_AGATHION_HAS_ALREADY_BEEN_SUMMONED = 2958; // Вы уже призвали Агатиона.
	public static final int YOUR_ACCOUNT_HAS_BEEN_TEMPORARILY_RESTRICTED_BECAUSE_IT_IS_SUSPECTED_OF_BEING_USED_ABNORMALLY = 2959; // Ваш аккаунт был заблокирован за неправомерные
																																	// действия внутри игры. Если вы не совершали таких
																																	// действий, вам необходимо зайти на веб-сайт игры и
																																	// пройти идентификацию личности. Более подробную
																																	// информацию вы можете получить, обратившись в
																																	// службу поддержки.
	...
	public static final int THE_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHT_QUANTITY_LIMIT_HAS_BEEN_EXCEEDED = 6006; // Вы не можете приобрести предмет, так как Ваш инвентарь
																																// переполнен.
	...
	public static final int YOU_ARE_NOT_AUTHORIZED_TO_MAKE_FURTHER_RECOMMENDATIONS_AT_THIS_TIME_YOU_WILL_RECEIVE_MORE_RECOMMENDATION_CREDITS_EACH_DAY_AT_1_PM = 833; // Вы использовали
																																										// все
																																										// рекомендации.
																																										// Количество
																																										// рекомендаций
	...
	public static final int YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = 1930; // Вы приняли вызов на дуэль, брошенный персонажем $c1. Дуэль сейчас
																													// начнется.
	public static final int S1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL = 1931; // $c1 отказывается от дуэли с Вами.
	public static final int YOU_HAVE_ACCEPTED_S1S_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = 1933; // Вы приняли вызов на групповую дуэль, брошенный персонажем
																															// $c1. Дуэль сейчас начнется.
	public static final int S1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_DUEL_AGAINST_THEIR_PARTY_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = 1934; // $c1 принимает вызов на групповую дуэль. Дуэль
																																	// сейчас начнется.
	...
	public static final int SINCE_THE_PERSON_YOU_CHALLENGED_IS_NOT_CURRENTLY_IN_A_PARTY_THEY_CANNOT_DUEL_AGAINST_YOUR_PARTY = 1937; // Персонаж, вызванный на дуэль, не состоит в группе
																																	// и не может сражаться против Вашей группы.
	...
	public static final int S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_ENGAGED_IN_A_PRIVATE_STORE_OR_MANUFACTURE = 2017; // $c1 не может вступить в дуэль, поскольку в данный момент
																														// находится в личной торговой лавке или мастерской.
	...
	public static final int S1_CANNOT_MAKE_A_CHALLANGE_TO_A_DUEL_BECAUSE_S1_IS_CURRENTLY_IN_A_DUEL_PROHIBITED_AREA = 2020; // $c1 не может принять вызов на дуэль, поскольку находится в
																															// зоне, где дуэли запрещены.
	...
	public static final int S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_RIDING_A_BOAT_WYVERN_OR_STRIDER = 2027; // $c1 не может вступить в дуэль, поскольку в данный момент находится в личной
																											// торговой лавке или мастерской.
	...
	public static final int YOU_CANNOT_ADD_ELEMENTAL_POWER_WHILE_OPERATING_A_PRIVATE_STORE_OR_PRIVATE_WORKSHOP = 2143; // Вы не можете добавить силу стихий, пока находитесь в личной
																														// торговой лавке или мастерской.
	...
	public static final int ANOTHER_ELEMENTAL_POWER_HAS_ALREADY_BEEN_ADDED_THIS_ELEMENTAL_POWER_CANNOT_BE_ADDED = 2150; // Другая сила стихии уже была добавлена. Эта сила стихии не
	...
	public static final int PARTY_DUEL_CANNOT_BE_INITIATED_DUEL_TO_A_POLYMORPHED_PARTY_MEMBER = 2175; // Групповая дуэль не может состояться из-за измененной формы одного из членов
																										// группы.
	...
	public static final int ONLY_A_CLAN_LEADER_WHOSE_CLAN_IS_OF_LEVEL_2_OR_HIGHER_IS_ALLOWED_TO_PARTICIPATE_IN_A_CLAN_HALL_AUCTION = 673; // Участвовать в аукционе холлов кланов могут
																																			// только кланы 2-го уровня и выше.
	...
	public static final int SINCE_YOU_HAVE_ALREADY_SUBMITTED_A_BID_YOU_ARE_NOT_ALLOWED_TO_PARTICIPATE_IN_ANOTHER_AUCTION_AT_THIS_TIME = 676; // Вы уже внесли свою ставку, поэтому
																																				// участие в другом аукционе невозможно.
	...
	public static final int THE_CLAN_HALL_WHICH_HAD_BEEN_PUT_UP_FOR_AUCTION_WAS_NOT_SOLD_AND_THEREFORE_HAS_BEEN_RELISTED = 777; // Холл, выставленный на аукционе, не был продан и
																																// возвращается в список холлов, выставленных на продажу.
	...
	public static final int YOU_CANNOT_AUGMENT_ITEMS_WHILE_A_PRIVATE_STORE_OR_PRIVATE_WORKSHOP_IS_IN_OPERATION = 1972; // Вы не можете зачаровать предметы, пока действует режим торговой
																														// лавки или мастерской.
	...
	public static final int THE_NEARBLY_AREA_IS_TOO_NARROW_FOR_YOU_TO_POLYMORPH_PLEASE_MOVE_TO_ANOTHER_AREA_AND_TRY_TO_POLYMORPH_AGAIN = 2059; // Окружающее пространство слишком тесно
																																				// для вашего превращения. Пожалуйста,
																																				// отойдите в другую зону и попробуйте
																																				// превратиться снова.
	...
	public static final int C1_IS_IN_A_LOCATION_WHICH_CANNOT_BE_ENTERED_THEREFORE_IT_CANNOT_BE_PROCESSED = 2096; // $c1 находится в локации, в которую нельзя войти, поэтому действие
																													// невозможно.
	...
	public static final int YOU_HAVE_ENTERED_ANOTHER_INSTANCE_ZONE_THEREFORE_YOU_CANNOT_ENTER_CORRESPONDING_DUNGEON = 2105; // Вы уже вошли в другую временную зону, поэтому не можете
																															// войти в данную.
	...
	public static final int THIS_INSTANCE_ZONE_WILL_BE_TERMINATED_IN_S1_MINUTES_YOU_WILL_BE_FORCED_OUT_OF_THE_DANGEON_THEN_TIME_EXPIRES = 2107; // Временная зона закроется через $s1
																																				// мин. По истечении времени вы будете
																																				// выброшены из подземелья.
	...
	public static final int YOUR_BIRTHDAY_GIFT_HAS_ARRIVED_YOU_CAN_OBTAIN_IT_FROM_THE_GATEKEEPER_IN_ANY_VILLAGE = 2448; // Доставлен подарок в честь дня создания персонажа. Вы можете
																														// получить его у Хранителя Портала любой из деревень.
	public static final int THERE_ARE_S1_DAYS_UNTIL_YOUR_CHARACTERS_BIRTHDAY_ON_THAT_DAY_YOU_CAN_OBTAIN_A_SPECIAL_GIFT_FROM_THE_GATEKEEPER_IN_ANY_VILLAGE = 2449; // До дня создания
																																									// персонажа осталось
																																									// $s1 дн. Вы можете
																																									// получить подарок у
																																									// Хранителя Портала
	...
	public static final int _IF_YOU_JOIN_THE_CLAN_ACADEMY_YOU_CAN_BECOME_A_CLAN_MEMBER_AND_LEARN_THE_GAME_SYSTEM_UNTIL_YOU = 2875; // Поступив в Академию клана, Вы можете стать его
																																	// членом и изучать игровую систему до получения
																																	// 40-го уровня. Если хотите получать от игры больше
																																	// удовольствия, то настоятельно рекомендуем Вам
																																	// поступить в Академию.
	public static final int _IF_YOU_BECOME_LEVEL_40_THE_SECOND_CLASS_CHANGE_IS_AVAILABLE_IF_YOU_COMPLETE_THE_SECOND_CLASS = 2876; // По достижении 40-го уровня Вы получаете возможность
																																	// второй смены профессии. После выполнения этого
																																	// действия возможности Вашего персонажа возрастут.
	...
	public static final int BEING_APPOINTED_AS_A_NOBLESSE_WILL_CANCEL_ALL_RELATED_QUESTS_DO_YOU_WISH_TO_CONTINUE = 2964; // Если Вы станете Дворянином, все выполняемые квесты будут
																															// удалены. Продолжить?
	public static final int YOU_CANNOT_PURCHASE_AND_RE_PURCHASE_THE_SAME_TYPE_OF_ITEM_AT_THE_SAME_TIME = 2965; // Первичная и повторная покупка предметов одинакового типа одновременно
																												// невозможна.
	...
	public static final int THE_PREVIOUS_MAIL_WAS_FORWARDED_LESS_THAN_1_MINUTE_AGO_AND_THIS_CANNOT_BE_FORWARDED = 2969; // С момента пересылки предыдущего письма не прошло одной минуты,
																														// поэтому отправка невозможна.
	...
	public static final int WHEN_AN_COMMAND_CHANNEL_LEADER_GOES_OUT_OF_THE_COMMAND_CHANNEL_MATCHING_ROOM_THE_CURRENTLY_OPEN = 2993; // При выходе Командира Альянса Комната Поиска Союза
																																	// закроется. Хотите выйти?
	...
	public static final int THE_COMMAND_CHANNEL_AFFILIATED_PARTY_S_PARTY_MEMBER_CANNOT_USE_THE_MATCHING_SCREEN = 2999; // Член группы, входящей в Канал Союза, не может использовать окно
																														// поиска.
	...
	public static final int WHEN_THE_RECIPIENT_DOESN_T_EXIST_OR_THE_CHARACTER_HAS_BEEN_DELETED_SENDING_MAIL_IS_NOT_POSSIBLE = 3002; // Невозможно отправить письмо, если получатель не
																																	// существует или данный персонаж удален.
	public static final int C1_ENTERED_THE_COMMAND_CHANNEL_MATCHING_ROOM = 3003; // $c1 вошел в Комнату Поиска Союза.
	public static final int I_M_SORRY_TO_GIVE_YOU_A_SATISFACTORY_RESPONSE__N__NIF_YOU_SEND_YOUR_COMMENTS_REGARDING_THE = 3004; // Извините, что не смогли дать удовлетворяющий Вас
																																// ответ.\\n\\nЕсли Вы скажете, что именно вызвало
																																// недовольство, мы сделаем все, чтобы это больше не
	...
	public static final int YOU_CANNOT_USE_ANY_SKILL_ENHANCING_SYSTEM_UNDER_YOUR_STATUS_CHECK_OUT_THE_PC_S_CURRENT_STATUS = 3017; // Вы не можете использовать систему улучшения умения.
																																	// Проверьте состояние вашего персонажа.
	...
	public static final int YOU_CANNOT_USE_THE_SKILL_ENHANCING_FUNCTION_ON_THIS_LEVEL_YOU_CAN_USE_THE_CORRESPONDING_FUNCTION = 3026; // На данном уровне вы не можете улучшить умение.
																																		// Эта функция доступна игрокам, достигшим 76-го
																																		// уровня.
	public static final int YOU_CANNOT_USE_THE_SKILL_ENHANCING_FUNCTION_IN_THIS_CLASS_YOU_CAN_USE_CORRESPONDING_FUNCTION = 3027; // Ваша профессия не позволяет использовать функцию
																																	// улучшения умения. Она доступна после 3-й смены
																																	// профессии.
	public static final int YOU_CANNOT_USE_THE_SKILL_ENHANCING_FUNCTION_IN_THIS_CLASS_YOU_CAN_USE_THE_SKILL_ENHANCING = 3028; // Ваше состояние не позволяет улучшить умение. Эта функция
																																// доступна, если вы не перевоплощены, не сражаетесь и не
																																// сидите верхом на ездовом существе.
	...
	public static final int IN_ORDER_TO_HELP_ANAKIM_ACTIVATE_THE_SEALING_DEVICE_OF_THE_EMPEROR_WHO_IS_POSSESED_BY_THE_EVIL = 3032; // Чтобы помочь Анакиму, активируйте Устройство Печати
																																	// Императора, проклятое Лилит! Сила проклятия
																																	// ужасающа, остерегайтесь ее!
	public static final int BY_USING_THE_INVISIBLE_SKILL_SNEAK_INTO_THE_DAWN_S_DOCUMENT_STORAGE = 3033; // Воспользуйтесь умением стража "Скрыться", чтобы попасть в Хранилище Документов
																										// Рассвета!
	public static final int THE_DOOR_IN_FRONT_OF_US_IS_THE_ENTRANCE_TO_THE_DAWN_S_DOCUMENT_STORAGE_APPROACH_TO_THE_CODE = 3034; // Прямо перед вами Библиотека Рассвета! Подойдите к
																																// Устройству Ввода Пароля!
	public static final int MY_POWER_S_WEAKENING_PLEASE_ACTIVATE_THE_SEALING_DEVICE_POSSESSED_BY_LILITH_S_MAGICAL_CURSE = 3035; // Наша сила иссякает. Активируйте проклятое Лилит
																																// Устройство Печати!
	...
	public static final int FEMALE_GUARDS_NOTICE_THE_DISGUISES_FROM_FAR_AWAY_BETTER_THAN_THE_MALE_GUARDS_DO_SO_BEWARE = 3038; // Стражницы обнаруживают перевоплощенных игроков на
																																// большей дистанции, чем стражники, так что
																																// остерегайтесь их.
	public static final int BY_USING_THE_HOLY_WATER_OF_EINHASAD_OPEN_THE_DOOR_POSSESSED_BY_THE_CURSE_OF_FLAMES = 3039; // Воспользуйтесь Святой Водой Эйнхасад, чтобы открыть Дверь
																														// Огненного Проклятия.
	public static final int BY_USING_THE_COURT_MAGICIAN_S_MAGIC_STAFF_OPEN_THE_DOOR_ON_WHICH_THE_MAGICIAN_S_BARRIER_IS = 3040; // Воспользуйтесь Скипетром Королевского Волшебника, чтобы
																																// открыть Грань Реальности Волшебника.
	...
	public static final int S1_DID_NOT_RECEIVE_IT_DURING_THE_WAITING_TIME_SO_IT_WAS_RETURNED_AUTOMATICALLY_TNTLS = 3059; // $s1 не получил посылку в установленное время, поэтому она
																															// возвращена.
	...
	public static final int SKILL_NOT_AVAILABLE_TO_BE_ENHANCED_CHECK_SKILL_S_LV_AND_CURRENT_PC_STATUS = 3070; // Это умение улучшить нельзя. Проверьте уровень умения и состояние
																												// персонажа.
	...
	public static final int THE_MAIL_LIMIT_240_OF_THE_OPPONENT_S_CHARACTER_HAS_BEEN_EXCEEDED_AND_THIS_CANNOT_BE_FORWARDED = 3077; // У получателя переполнен почтовый ящик (240 ед.),
																																	// поэтому отправка невозможна.
	public static final int YOU_RE_MAKING_A_REQUEST_FOR_PAYMENT_DO_YOU_WANT_TO_PROCEED = 3078; // Оплата. Отправить деньги?
	public static final int THERE_ARE_ITEMS_IN_THE_PET_INVENTORY_SO_YOU_CANNOT_REGISTER_AS_AN_INDIVIDUAL_STORE_OR_DROP_ITEMS = 3079; // В инвентаре Питомца имеются предметы, поэтому
																																		// обменять его, выставить на продажу в личной
																																		// торговой лавке или прогнать нельзя. Сначала
																																		// очистите инвентарь Питомца.
	...
	public static final int YOU_CANNOT_RECEIVE_IT_BECAUSE_YOU_ARE_UNDER_THE_CONDITION_THAT_THE_OPPONENT_CANNOT_ACQUIRE_ANY = 3081; // Партнер не может получить деньги, поэтому купить
	...
	public static final int IN_THE_PROCESS_OF_WORKING_ON_THE_PREVIOUS_CLAN_DECLARATION_RETREAT_PLEASE_TRY_AGAIN_LATER = 3083; // Идет обработка информации о прошлой войне кланов.
	...
	public static final int THIS_MAIL_IS_BEING_SENT_WITH_A_PAYMENT_REQUEST_WOULD_YOU_LIKE_TO_CONTINUE = 3087; // Это функция предназначена для перечисления денег. Вы согласны
																												// продолжить?
	public static final int YOU_HAVE_S1_HOURS_S2_MINUTES_AND_S3_SECONDS_LEFT_IN_THE_PROOF_OF_SPACE_AND_TIME_IF_AGATHION_IS = 3088; // До повторного предоставления Свидетельства
																																	// Пространства осталось $s1час. $s2мин. $s3сек.
																																	// (Если в данный период повторно призвать Агатиона,
																																	// то можно продлить время на 10 мин.)
	public static final int YOU_HAVE_S1_MINUTES_AND_S2_SECONDS_LEFT_IN_THE_PROOF_OF_SPACE_AND_TIME_IF_AGATHION_IS_SUMMONED = 3089; // До повторного предоставления Свидетельства
																																	// Пространства осталось $s1мин. $s2сек. (Если в
																																	// данный период повторно призвать Агатиона, то можно
																																	// продлить время на 10 мин.)
	public static final int YOU_HAVE_S1_SECONDS_LEFT_IN_THE_PROOF_OF_SPACE_AND_TIME_IF_AGATHION_IS_SUMMONED_WITHIN_THIS_TIME = 3090; // До повторного предоставления Свидетельства
																																		// Пространства осталось $s1сек. (Если в данный
																																		// период повторно призвать Агатиона, то можно
																																		// продлить время на 10 мин.)
	...
	public static final int YOU_ACQUIRED_S1_EXP_AND_S2_SP_AS_A_REWARD_YOU_RECEIVE_S3_MORE_EXP = 6011; // Вы получили $s1 очков опыта и $s2 SP. (В награду вы дополнительно получаете $s3
																										// очков опыта.)
	public static final int A_BLESSING_THAT_INCREASES_EXP_BY_1_2 = 6012; // Количество очков опыта увеличивается на $s1 $s2
	public static final int IT_IS_NOT_A_BLESSING_PERIOD_WHEN_YOU_REACH_TODAY_S_TARGET_YOU_CAN_RECEIVE_S1 = 6013; // Сейчас Ивент не проводится. Вам необходимо достичь сегодняшнюю цель,
																													// и тогда вы получите награду: $s1.
	...
	public static final int ONLY_THE_TOP_S1_APPEAR_IN_THE_RANKING_AND_ONLY_THE_TOP_S2_ARE_RECORDED_IN_MY_BEST_RANKING = 6033; // В рейтинге отображается до $s1 чел., а самые первые $s2
																																// чел. записываются в Мой высший рейтинг.
	public static final int S1_HAVE_HAS_BEEN_INITIALIZED = 6034; // $s1 обнулилось.
	public static final int WHEN_THERE_ARE_MANY_PLAYERS_WITH_THE_SAME_SCORE_THEY_APPEAR_IN_THE_ORDER_IN_WHICH_THEY_WERE = 6035; // Если одинаковое количество очков набрало несколько
																																// персонажей, то выше отобразится тот, кто набрал их
																																// раньше.

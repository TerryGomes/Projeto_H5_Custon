...
import l2mv.gameserver.skills.effects.EffectAddSkills;
import l2mv.gameserver.skills.effects.EffectAgathionRes;
import l2mv.gameserver.skills.effects.EffectAggression;
import l2mv.gameserver.skills.effects.EffectBetray;
import l2mv.gameserver.skills.effects.EffectBlessNoblesse;
import l2mv.gameserver.skills.effects.EffectBlockStat;
import l2mv.gameserver.skills.effects.EffectBluff;
import l2mv.gameserver.skills.effects.EffectBuff;
import l2mv.gameserver.skills.effects.EffectCPDamPercent;
import l2mv.gameserver.skills.effects.EffectCallSkills;
import l2mv.gameserver.skills.effects.EffectCharge;
import l2mv.gameserver.skills.effects.EffectCharmOfCourage;
import l2mv.gameserver.skills.effects.EffectCombatPointHealOverTime;
import l2mv.gameserver.skills.effects.EffectConsumeSoulsOverTime;
import l2mv.gameserver.skills.effects.EffectCubic;
import l2mv.gameserver.skills.effects.EffectCurseOfLifeFlow;
import l2mv.gameserver.skills.effects.EffectDamOverTime;
import l2mv.gameserver.skills.effects.EffectDamOverTimeLethal;
import l2mv.gameserver.skills.effects.EffectDebuffImmunity;
import l2mv.gameserver.skills.effects.EffectDestroySummon;
import l2mv.gameserver.skills.effects.EffectDisarm;
import l2mv.gameserver.skills.effects.EffectDiscord;
import l2mv.gameserver.skills.effects.EffectDispelEffects;
import l2mv.gameserver.skills.effects.EffectEnervation;
import l2mv.gameserver.skills.effects.EffectFakeDeath;
import l2mv.gameserver.skills.effects.EffectFear;
import l2mv.gameserver.skills.effects.EffectGrow;
import l2mv.gameserver.skills.effects.EffectHPDamPercent;
import l2mv.gameserver.skills.effects.EffectHate;
import l2mv.gameserver.skills.effects.EffectHeal;
import l2mv.gameserver.skills.effects.EffectHealBlock;
import l2mv.gameserver.skills.effects.EffectHealCPPercent;
import l2mv.gameserver.skills.effects.EffectHealOverTime;
import l2mv.gameserver.skills.effects.EffectHealPercent;
import l2mv.gameserver.skills.effects.EffectHourglass;
import l2mv.gameserver.skills.effects.EffectImmobilize;
import l2mv.gameserver.skills.effects.EffectInterrupt;
import l2mv.gameserver.skills.effects.EffectInvisible;
import l2mv.gameserver.skills.effects.EffectInvulnerable;
import l2mv.gameserver.skills.effects.EffectLDManaDamOverTime;
import l2mv.gameserver.skills.effects.EffectLockInventory;
import l2mv.gameserver.skills.effects.EffectMPDamPercent;
import l2mv.gameserver.skills.effects.EffectManaDamOverTime;
import l2mv.gameserver.skills.effects.EffectManaHeal;
import l2mv.gameserver.skills.effects.EffectManaHealOverTime;
import l2mv.gameserver.skills.effects.EffectManaHealPercent;
import l2mv.gameserver.skills.effects.EffectMeditation;
import l2mv.gameserver.skills.effects.EffectMute;
import l2mv.gameserver.skills.effects.EffectMuteAll;
import l2mv.gameserver.skills.effects.EffectMuteAttack;
import l2mv.gameserver.skills.effects.EffectMutePhisycal;
import l2mv.gameserver.skills.effects.EffectNegateEffects;
import l2mv.gameserver.skills.effects.EffectNegateMusic;
import l2mv.gameserver.skills.effects.EffectParalyze;
import l2mv.gameserver.skills.effects.EffectPetrification;
import l2mv.gameserver.skills.effects.EffectRandomHate;
import l2mv.gameserver.skills.effects.EffectRelax;
import l2mv.gameserver.skills.effects.EffectRemoveTarget;
import l2mv.gameserver.skills.effects.EffectRestoration;
import l2mv.gameserver.skills.effects.EffectRestorationRandom;
import l2mv.gameserver.skills.effects.EffectRoot;
import l2mv.gameserver.skills.effects.EffectSalvation;
import l2mv.gameserver.skills.effects.EffectServitorShare;
import l2mv.gameserver.skills.effects.EffectSilentMove;
import l2mv.gameserver.skills.effects.EffectSleep;
import l2mv.gameserver.skills.effects.EffectStun;
import l2mv.gameserver.skills.effects.EffectSummonHealPercent;
import l2mv.gameserver.skills.effects.EffectSummonManaHealPercent;
import l2mv.gameserver.skills.effects.EffectSymbol;
import l2mv.gameserver.skills.effects.EffectTemplate;
import l2mv.gameserver.skills.effects.EffectTransformation;
import l2mv.gameserver.skills.effects.EffectUnAggro;
import l2mv.gameserver.skills.effects.EffectVitalityDamOverTime;
import l2mv.gameserver.skills.effects.EffectVitalityStop;

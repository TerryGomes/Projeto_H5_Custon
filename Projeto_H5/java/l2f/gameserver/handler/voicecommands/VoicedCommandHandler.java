...
import l2f.gameserver.handler.voicecommands.impl.BuffStoreVoice;
...
import l2f.gameserver.handler.voicecommands.impl.DressMe;
import l2f.gameserver.handler.voicecommands.impl.FacebookVoice;
...
import l2f.gameserver.handler.voicecommands.impl.ItemLogsVoice;
...
import l2f.gameserver.handler.voicecommands.impl.PollVoice;
...
import l2f.gameserver.handler.voicecommands.impl.RuVotePanel;
import l2f.gameserver.handler.voicecommands.impl.Security;
import l2f.gameserver.handler.voicecommands.impl.ServerInfo;
import l2f.gameserver.handler.voicecommands.impl.SiegeVoice;
import l2f.gameserver.handler.voicecommands.impl.StreamVoice;
import l2f.gameserver.handler.voicecommands.impl.Teleport;
import l2f.gameserver.handler.voicecommands.impl.TournamentVoice;
import l2f.gameserver.handler.voicecommands.impl.VoiceGmEvent;
import l2f.gameserver.handler.voicecommands.impl.VoteReward;
...
import l2f.gameserver.masteriopack.rankpvpsystem.VoicedCommandHandlerPvpInfo;

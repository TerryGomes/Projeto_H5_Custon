...
import l2f.gameserver.network.serverpackets.ExMultiPartyCommandChannelInfo;
...
public class CommandChannel implements IUserCommandHandler
{
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		case 93: // channeldelete
			...
			{
				l2f.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();

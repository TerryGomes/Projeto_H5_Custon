...
{
	protected SpawnTask[] _spawnTasks = new SpawnTask[500];
	protected int _spawnTasksSize = 0;
	protected final Object spawnTasks_lock = new Object();
	...
	public void cancelSpawnTask(NpcInstance actor)
	{
		removeObject(actor);
	}

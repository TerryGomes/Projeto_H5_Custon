...
import l2f.gameserver.fandc.tournament.TournamentConfig;
...
public abstract class AbstractTournament
{
	...
	public synchronized void handleRegUnReg(Player player)
	{
		...
		for (ItemHolder holder : TournamentConfig.REQUIRES)
		{
			...
			{
				player.sendMessage("You don't have " + holder.getCount() + " " + l2f.gameserver.data.xml.holder.ItemHolder.getInstance().getItemName(holder.getItemId()));
				return;
			}
		}

...
import l2f.gameserver.network.serverpackets.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2f.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}

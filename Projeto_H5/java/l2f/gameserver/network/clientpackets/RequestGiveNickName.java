...
import l2f.gameserver.network.serverpackets.NickNameChanged;
...
public class RequestGiveNickName extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2f.gameserver.clientpackets.RequestGiveNickName.NotInClan", activeChar));
		}

...
public class DatabaseFactory extends BasicDataSource
{
	...
	{
		super(Config.DATABASE_DRIVER, Config.DATABASE_GAME_URL, Config.DATABASE_GAME_USER, Config.DATABASE_GAME_PASSWORD, Config.DATABASE_MAX_CONNECTIONS, Config.DATABASE_MAX_CONNECTIONS,

...
public class LoginDatabaseFactory extends BasicDataSource
{
	...
	{
		super(Config.DATABASE_DRIVER, Config.DATABASE_LOGIN_URL, Config.DATABASE_LOGIN_USER, Config.DATABASE_LOGIN_PASSWORD, Config.DATABASE_MAX_CONNECTIONS, Config.DATABASE_MAX_CONNECTIONS, Config.DATABASE_MAX_IDLE_TIMEOUT, Config.DATABASE_IDLE_TEST_PERIOD, false);
	}

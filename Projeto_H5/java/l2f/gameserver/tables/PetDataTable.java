...
public class PetDataTable
{
	...
	private void load()
	{
		...
		try
		{
			...
			statement = con.prepareStatement(
						"SELECT id, level, exp, hp, mp, patk, pdef, matk, mdef, acc, evasion, crit, speed, atk_speed, cast_speed, max_meal, battle_meal, normal_meal, loadMax, hpregen, mpregen FROM pet_data");
	...
	public static enum L2Pet
	{
		...
		HATCHLING_WIND(HATCHLING_WIND_ID, 3500, 4038, false, 1, 12, .30, 2, 2), HATCHLING_STAR(HATCHLING_STAR_ID, 3501, 4038, false, 1, 12, .30, 2, 2),
		HATCHLING_TWILIGHT(HATCHLING_TWILIGHT_ID, 3502, 4038, false, 1, 100, .30, 2, 2),

		STRIDER_WIND(STRIDER_WIND_ID, 4422, 5168, true, 1, 12, .30, 2, 2), STRIDER_STAR(STRIDER_STAR_ID, 4423, 5168, true, 1, 12, .30, 2, 2),
		STRIDER_TWILIGHT(STRIDER_TWILIGHT_ID, 4424, 5168, true, 1, 100, .30, 2, 2),

		RED_STRIDER_WIND(RED_STRIDER_WIND_ID, 10308, 5168, true, 1, 12, .30, 2, 2), RED_STRIDER_STAR(RED_STRIDER_STAR_ID, 10309, 5168, true, 1, 12, .30, 2, 2),
		RED_STRIDER_TWILIGHT(RED_STRIDER_TWILIGHT_ID, 10310, 5168, true, 1, 100, .30, 2, 2),

		WYVERN(WYVERN_ID, 5249, 6316, true, 1, 12, .0, 2, 2),

		GREAT_WOLF(GREAT_WOLF_ID, 9882, 9668, false, 55, 10, .30, 2, 2), WGREAT_WOLF(WGREAT_WOLF_ID, 10307, 9668, true, 55, 12, .30, 2, 2), FENRIR_WOLF(FENRIR_WOLF_ID, 10426, 9668, true, 70, 12, .30, 2, 2),
		WFENRIR_WOLF(WFENRIR_WOLF_ID, 10611, 9668, true, 70, 12, .30, 2, 2),

		BABY_BUFFALO(BABY_BUFFALO_ID, 6648, 7582, false, 1, 12, .05, 2, 2), BABY_KOOKABURRA(BABY_KOOKABURRA_ID, 6650, 7582, false, 1, 12, .05, 2, 2),
		BABY_COUGAR(BABY_COUGAR_ID, 6649, 7582, false, 1, 12, .05, 2, 2),

		IMPROVED_BABY_BUFFALO(IMPROVED_BABY_BUFFALO_ID, 10311, 10425, false, 55, 12, .30, 2, 2), IMPROVED_BABY_KOOKABURRA(IMPROVED_BABY_KOOKABURRA_ID, 10313, 10425, false, 55, 12, .30, 2, 2),
		...
		FOX_SHAMAN(FOX_SHAMAN_ID, 13020, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), FOX_SHAMAN_EVENT(FOX_SHAMAN_ID, 13306, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		...
		WHITE_WEASEL(WHITE_WEASEL_ID, 13017, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), WHITE_WEASEL_EVENT(WHITE_WEASEL_ID, 13303, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		FAIRY_PRINCESS(FAIRY_PRINCESS_ID, 13018, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), FAIRY_PRINCESS_EVENT(FAIRY_PRINCESS_ID, 13304, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		OWL_MONK(OWL_MONK_ID, 13550, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), OWL_MONK_EVENT(OWL_MONK_ID, 14063, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		SPIRIT_SHAMAN(SPIRIT_SHAMAN_ID, 14062, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), SOUL_MONK(SPIRIT_SHAMAN_ID, 13549, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		TOY_KNIGHT(TOY_KNIGHT_ID, 14061, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2), TOY_KNIGHT_2(TOY_KNIGHT_ID, 13548, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .30, 2, 2),
		TURTLE_ASCETIC(TURTLE_ASCETIC_ID, 14064, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .01, 2, 2), TURTLE_ASCETIC_2(TURTLE_ASCETIC_ID, 13551, Config.VITAMIN_PETS_FOOD_ID, false, 25, 12, .01, 2, 2),

		DEINONYCHUS(DEINONYCHUS_ID, 14828, 2515, false, 55, 12, .30, 2, 2), GUARDIANS_STRIDER(GUARDIANS_STRIDER_ID, 14819, 5168, true, 55, 12, .30, 2, 2), MAGUEN(MAGUEN_ID, 15488, 9668, true, 1, 10, .05, 2, 2),
		ELITE_MAGUEN(ELITE_MAGUEN_ID, 15489, 9668, true, 1, 10, .05, 2, 2),

		ROSE_DESELOPH(ROSE_DESELOPH_ID, 20908, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2), ROSE_HYUM(ROSE_HYUM_ID, 20909, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2),
		ROSE_REKANG(ROSE_REKANG_ID, 20910, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2), ROSE_LILIAS(ROSE_LILIAS_ID, 20911, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2),
		ROSE_LAPHAM(ROSE_LAPHAM_ID, 20912, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2), ROSE_MAPHUM(ROSE_MAPHUM_ID, 20913, Config.VITAMIN_DESELOT_FOOD_ID, false, 55, 12, .01, 2, 2),

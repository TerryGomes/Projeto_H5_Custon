...
public final class AccountKicked extends L2LoginServerPacket
{
	...
	{
		REASON_FALSE_DATA_STEALER_REPORT(0x00), REASON_DATA_STEALER(0x01), REASON_SOUSPICION_DATA_STEALER(0x03), REASON_NON_PAYEMENT_CELL_PHONE(0x04), REASON_30_DAYS_SUSPENDED_CASH(0x08),

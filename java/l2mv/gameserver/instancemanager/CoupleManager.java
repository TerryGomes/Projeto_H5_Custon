...
public class CoupleManager
{
	...
	private void load()
	{
		...
		{
			_log.error("Error while loading couples ", e);
		}
		finally
		{
	...
	public void notifyPartner(Player cha)
	{
		if (cha.getPartnerId() != 0)
		{
			...
			if (partner != null)
			{
				partner.sendMessage(new CustomMessage("l2mv.gameserver.instancemanager.CoupleManager.PartnerEntered", partner));
			}
		}
	}
	...
	public void store()
	{
		...
		{
			_log.error("Error while Storing Couple Manager! ", e);
		}
		finally
		{

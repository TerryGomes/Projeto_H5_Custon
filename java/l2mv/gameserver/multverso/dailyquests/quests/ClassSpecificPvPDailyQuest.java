...
public class ClassSpecificPvPDailyQuest extends AbstractDailyQuest
{
	...
	protected String writeQuestInfo(Player player)
	{
		...
		sb.append("</table>");
		sb.append("Você deve caçar aleatoriamente entre " + getMinKillsRequired() + " as " + getMaxKillsRequired() + " classes da lista acima para completar a missão.<br1>");
		return sb.toString();
	}
	...
	protected String writeQuestProgress(Player player)
	{
		...
		sb.append("</table>");
		sb.append("Você deve caçar " + st.getInt("CLASS_COUNT") + " classes da lista acima para completar a missão.<br1>");
		return sb.toString();
	}

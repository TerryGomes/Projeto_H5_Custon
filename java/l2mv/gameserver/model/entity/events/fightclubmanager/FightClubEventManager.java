...
import l2mv.gameserver.network.serverpackets.TutorialShowQuestionMark;
...
public class FightClubEventManager
{
	...
	/**
	 * Checking {@link #canPlayerParticipate(l2mv.gameserver.model.Player, boolean, boolean)} for every player participated in event. Sending Message, checking all condtions

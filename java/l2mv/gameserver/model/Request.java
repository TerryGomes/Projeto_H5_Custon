...
public class Request extends MultiValueSet<String>
{
	...
	{
		CUSTOM, PARTY, PARTY_ROOM, CLAN, ALLY, TRADE, TRADE_REQUEST, FRIEND, CHANNEL, DUEL, POST, COUPLE_ACTION, AUCTION_ITEM_ADD, CLAN_WAR_START, CLAN_WAR_STOP, CLAN_WAR_SURRENDER
	}
